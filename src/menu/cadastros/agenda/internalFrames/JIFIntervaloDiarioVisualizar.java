...
public class JIFIntervaloDiarioVisualizar extends javax.swing.JInternalFrame {
    ...
    public void PreenchendoTabela(){
        ...
        try{
            while(resultSet.next()){
                ...
                modelo.addRow(new String[] {String.valueOf(resultSet.getString("A_INTERVALODIARIONID")), resultSet.getString("nome")});
            } 
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos os Intervalos Diários", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
...
this.dispose();
        ...
        janelaPrincipal.internalFrameIntervalosDiarios.setLocation( lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2 );        // TODO add your handling code here:
