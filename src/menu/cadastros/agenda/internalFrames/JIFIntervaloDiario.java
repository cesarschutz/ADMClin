...
public class JIFIntervaloDiario extends javax.swing.JInternalFrame {
    ...
    public JIFIntervaloDiario(String novoOuEditar, int intervaloDiarioId) {
        ...
        if("novo".equals(novoOuEditar)){
            ...
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastrar novo Intervalo Diário", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        }
        if("editar".equals(novoOuEditar)){
            jBSalvar.setVisible(false);
            this.intervaloDiarioId = intervaloDiarioId;
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editar Intervalo Diário", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    public void preenchendoDadosDoIntervalo(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher dados do Intervalo Diário. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void preenchendoTabela(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher as Agendas do intervalo. Procure o administrador" + e,"ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        Conexao.fechaConexao(con);
    }
    ...
    public void botaoCancelar(){
        ...
        janelaPrincipal.internalFrameIntervalosDiariosVisualizar.setLocation( lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2 );
    }
    ...
    private void initComponents() {
        ...
        jTFHorarioInicial = new JFormattedTextField(new ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("##:##"));
        jTFHorarioFinal = new JFormattedTextField(new ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("##:##"));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jTFHorarioInicial, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jTFHorarioFinal, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(jTFNome, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 308, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
