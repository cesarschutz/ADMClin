...
public class conveniosFilmeDAO {
    ...
    public static ResultSet getConsultar(Connection con, int handle_convenio){
        ...
        try{
        PreparedStatement stmtQuery = con.prepareStatement("select * from conveniofilme where handle_convenio=? order by dataavaler Desc");
        stmtQuery.setInt(1, handle_convenio);
        resultSet = stmtQuery.executeQuery();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Erro ao consultar Valor de Filme's do Convênio. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
    ...
    public static boolean getConsultarSeDataEhMenorQueAultimaCadastrada(Connection con, int handle_convenio, String dataAcadastrar){
        ...
        ResultSet resultSet = null;
        try{
        PreparedStatement stmtQuery = con.prepareStatement("select * from conveniofilme where handle_convenio=? order by dataavaler");
        stmtQuery.setInt(1, handle_convenio);
        resultSet = stmtQuery.executeQuery();
    ...
    public static boolean setCadastrar(Connection con, conveniosFilmeMODEL convenioFilmeMODEL){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao cadastrar Valor de Filme. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return cadastro;
        }
    }
    ...
    public static boolean setDeletar(Connection con, int handle_convenio){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Valores de Filme. Procure o Administrador." + e,"ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return deleto;
        }
    }
    ...
    public static boolean setDeletarUmValor(Connection con, int convenioFilmeId){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Valor de Filme. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return deleto;
        }
    }
