...
public class JIFCConvenios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTFCep =
            new JFormattedTextField(new ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("##.###-###"));
        ...
        jTFTelefone =
            new JFormattedTextField(
                new ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("(##) ####-####"));
