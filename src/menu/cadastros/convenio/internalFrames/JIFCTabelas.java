...
public class JIFCTabelas extends javax.swing.JInternalFrame {
        ...
        try{
            while(resultSet.next()){
                ...
                modelo.addRow(new String[] {Integer.toString(resultSet.getInt("handle_exame")),
                    resultSet.getString("sinonimo"),resultSet.getString("cod_exame"),
    ...
    public void atualizarMateriasisDeUmExame(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possível atualizar os dados deste Exame. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            Conexao.fechaConexao(con);
        }
    ...
    public void botaoCadastrarMaterial(){
        ...
        janelaPrincipal.internalFrameTabelasAdicionarUmMaterial = new JIFCTabelasAdicionarUmMaterialAUmExame(nomeConvenio, handle_convenio, handle_exame, nomeExame);
        ...
        int lDesk = janelaPrincipal.jDesktopPane1.getWidth();     
                        ...
                        janelaPrincipal.internalFrameTabelasAdicionarUmMaterial.setLocation( lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2 );
    ...
    public void botaoCadastrarExame(){
        this.setVisible(false);
        janelaPrincipal.internalFrameTabelasAdicionarUmExame = new JIFCTabelasAdicionarUMExame(nomeConvenio, handle_convenio);
        ...
        int lDesk = janelaPrincipal.jDesktopPane1.getWidth();     
                        ...
                        janelaPrincipal.internalFrameTabelasAdicionarUmExame.setLocation( lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2 );
    }
    ...
    public void botaoEditarCoeficientes(){
        ...
        String handle_exame = (String) JIFCTabelas.jTable1.getValueAt(JIFCTabelas.jTable1.getSelectedRow(), 0);
        String nomeExame = (String) JIFCTabelas.jTable1.getValueAt(JIFCTabelas.jTable1.getSelectedRow(), 3);
        janelaPrincipal.internalFrameTabelasEditarCoefExame = new JIFCTabelasEditarCoeficientesDeUmExame(handle_convenio, nomeConvenio, handle_exame, nomeExame);
        ...
        janelaPrincipal.internalFrameTabelasEditarCoefExame.setVisible(true);
                ...
                int lDesk = janelaPrincipal.jDesktopPane1.getWidth();     
                        ...
                        janelaPrincipal.internalFrameTabelasEditarCoefExame.setLocation( lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2 );
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Exame(s)", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "handle_exame", "Sinonimo", "Código", "Exame(s)", "CH1", "CH2", "Coef. Filme"
            }
        ) {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jBAdicionarExame, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                            .addComponent(jBCancelar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addComponent(jBRemoverExame, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jBEditarCoeficientes, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCBModalidades, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Material(s)", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Handle_material", "Material(s)", "Quantidade", "tabelaId"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jBAdicionarMaterial, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jBRemoverMaterial, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jBAdicionarMaterial)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBRemoverMaterial)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Calcular Valor do Exame", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jBCalcularValorDoExame, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(jtfValorDoExame)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCBCalcularMateriais, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfValorDoExame, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(jCBCalcularMateriais, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTFNomeDaTabela, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
*/
    ...
    private void jBRetornarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jBRetornarKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {             botaoRetornar();         }     }//GEN-LAST:event_jBRetornarKeyPressed
    ...
    private void jBCalcularValorDoExameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCalcularValorDoExameActionPerformed
       SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");  
        ...
        if(jCBCalcularMateriais.getSelectedIndex() == 0){
             calculoValorDeExame calcularValorExame= new calculoValorDeExame(Integer.valueOf(handle_convenio), Integer.valueOf(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 0))), data, false);
             jtfValorDoExame.setText(MetodosUteis.colocarZeroEmCampoReais(calcularValorExame.valor_correto_exame));
        }else{
            calculoValorDeExame calcularValorExame = new calculoValorDeExame(Integer.valueOf(handle_convenio), Integer.valueOf(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 0))), data, true);
            jtfValorDoExame.setText(MetodosUteis.colocarZeroEmCampoReais(calcularValorExame.valor_correto_exame));
        }
