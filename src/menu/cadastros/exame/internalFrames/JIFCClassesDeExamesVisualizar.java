...
public class JIFCClassesDeExamesVisualizar extends javax.swing.JInternalFrame {
    ...
    public void atualizarTabela(){
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todas as Classes de Exames", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void jTFPesquisaNomeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTFPesquisaNomeFocusLost
        ...
        if( "".equals(verificar)){
            ...
            while(i<listaClassesDeExames.size()){
                DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
                modelo.addRow(new String[] {Integer.toString(listaClassesDeExames.get(i).getCod()),listaClassesDeExames.get(i).getDescricao()}); 
                i++;
            }
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos as Classes de Exames", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        }
    ...
    private void jTFPesquisaNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFPesquisaNomeKeyReleased
        ...
        if("".equals(jTFPesquisaNome.getText())){
            ...
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Classe(s) de Exame(s) encontrado(s) pela Pesquisa", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
