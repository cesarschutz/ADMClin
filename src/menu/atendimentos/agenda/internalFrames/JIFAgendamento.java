...
public class JIFAgendamento extends javax.swing.JInternalFrame {
     ...
     */
    public JIFAgendamento(String horarioLivreOuOcupado, int handle_ap, int handle_agenda, JTable tabelaSelecionada, JInternalFrame internalFrame) {
    ...
    public void preenchendoOsCamposDoAgendamentoCasoForEditarUmAgendamento(){
        ...
        try{
            while(resultSet.next()){
                ...
                jTFNascimento.setText(MetodosUteis.converterDataParaMostrarAoUsuario(resultSet.getString("nascimento")));
                jTFTelefone.setText(resultSet.getString("telefone"));
                telefonePacienteSelecionado = jTFTelefone.getText();
                if (!"(  )     -    ".equals(resultSet.getString("celular"))) jTFCelular.setText(resultSet.getString("celular"));
                ...
                jtfDuracaoAgendamento.setText(MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("duracaoDoAgendamento")));
                if (!"   .   .   -  ".equals(resultSet.getString("cpfPaciente")))jTFCpfPaciente.setText(resultSet.getString("cpfPaciente"));
                ...
                if("CM".equals(resultSet.getString("material")) || "CC".equals(resultSet.getString("material"))){
                    valorDoExame = new calculoValorDeExame(resultSet.getInt("handle_convenio"), resultSet.getInt("handle_exame"), dataDoExame, true).valor_correto_exame;
                }else{
                    valorDoExame = new calculoValorDeExame(resultSet.getInt("handle_convenio"), resultSet.getInt("handle_exame"), dataDoExame, false).valor_correto_exame;
                }
                ...
                modelo.addRow(new String[] {Integer.toString(resultSet.getInt("handle_exame")),resultSet.getString("nomeExame"),MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("duracaoDoExame")), MetodosUteis.colocarZeroEmCampoReais(valorDoExame), resultSet.getString("lado"), resultSet.getString("material"),resultSet.getString("ch_convenio"),resultSet.getString("filme_convenio"),resultSet.getString("ch1_exame"),resultSet.getString("ch2_exame"),resultSet.getString("filme_exame"),resultSet.getString("lista_materiais")});
                ...
                double valorPaciente = listaPorcentagemPaciente.get(jCBConvenio.getSelectedIndex()) * (valorTotal / 100);
                double valorConvenio = listaPorcentagemConvenio.get(jCBConvenio.getSelectedIndex()) * (valorTotal / 100);
    ...
    public void botaoPesquisar(){
        ...
        if(jTFPaciente.getText().length() >= 3){
            janelaPrincipal.internalFrameAgendamentoSelecionarUmPaciente = new JIFAgendamentoSelecionarUmPaciente(jTFPaciente.getText().toUpperCase());
            ...
            janelaPrincipal.internalFrameAgendamentoSelecionarUmPaciente.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2);
    ...
    public boolean verificarSeFoiTudoPreenchido(){
        ...
        boolean telefoneOK = MetodosUteis.verificarSeCampoComMascaraFoiPrenchido(jTFTelefone, jTFMensagemParaUsuario, "(  )     -    ");
    ...
    public void botaoSalvar  (){
        ...
        if(verificarSeFoiTudoPreenchido()){
            ...
            if(!jTFTelefone.getText().equals(telefonePacienteSelecionado) || !jTFCelular.getText().equals(celularPacienteSelecionado)){
            ...
            if(handle_ap>0){
                ...
                for(int i = 0; i < jTable1.getRowCount(); i++){
                    ...
                    agendamentoMODEL.setDuracaoAgendamento(MetodosUteis.transformarHorarioEmMinutos(jtfDuracaoAgendamento.getText()));
                    agendamentoMODEL.setDURACAODOEXAME(MetodosUteis.transformarHorarioEmMinutos(String.valueOf(jTable1.getValueAt(i, 2))));
                    agendamentoMODEL.setHANDLE_AP(handle_ap);
    ...
    public void botaoIncluirExame(){
        if(jCBExame.isEnabled() && jCBExame.getSelectedIndex()!=0){
            ...
            calculoValorDeExame calculoValorExame = new calculoValorDeExame(listaHandleConvenio.get(jCBConvenio.getSelectedIndex()),listaHandleExames.get(jCBExame.getSelectedIndex()), dataDoExame, false);
            ...
            //colocando o valor do exame
            modelo.addRow(new Object[] {handle_exame,nomeExame,duracaoExame,MetodosUteis.colocarZeroEmCampoReais(calculoValorExame.valor_correto_exame), "", "",chConvenio,filmeConvenio,ch1Exame,ch2Exame,filmeExame, ""});  
    ...
    private void initComponents() {
        ...
        jTFCpfPaciente = new JFormattedTextField(new br.bcn.admclin.ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("###.###.###-##"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Agendamento", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jtfDuracaoAgendamento, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE))
                            .addComponent(jTFAgenda, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtfDuracaoAgendamento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel2)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(31, 31, 31)
                                .addComponent(jTFTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(jTFCpfPaciente, javax.swing.GroupLayout.DEFAULT_SIZE, 75, Short.MAX_VALUE)
                                        .addGap(147, 147, 147)
                                        .addComponent(jTFHANDLE_PACIENTE, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jTFNascimento, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jBPesquisaPaciente, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Exames do Agendamento", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "HANDLE EXAME", "Exame(s)", "Duração", "Valor", "Lado", "Material", "chConvenio", "filmeConvenio", "ch1Exame", "ch2Exame", "filmeExame", "listaMateriais"
            }
        ) {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jBIncluirExame, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(jLabel16)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jCBModalidade, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jbImportarAgendamento, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jTFMensagemParaUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 868, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jBDeletarAgendamento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jbImportarAgendamento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jBArmazenarAgendamento, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
 ...
 botaoIncluirExame();        // TODO add your handling code here:
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getButton() == MouseEvent.BUTTON3) {
            ...
            int duracaoDoExameSelecionado = MetodosUteis.transformarHorarioEmMinutos((String) jTable1.getValueAt(linhaSelecionada, 2));
    ...
    public void mudarValorDeExameCasoMudeComMaterialOuComContraste(boolean somarValoresDeMateriais){
        //pegando a data da tabela que foi clicado para pesquisar os valores dos exames com ela
           ...
           calculoValorExame = new calculoValorDeExame(listaHandleConvenio.get(jCBConvenio.getSelectedIndex()),Integer.valueOf(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 0))), dataDoExame, somarValoresDeMateriais); 
    ...
    public void importarAgendamentoCancelado(){
        if(!JIFUmaAgenda.listaAgendamentoCanceladoPorUltimo.isEmpty()){
            ...
            for (A_Agendamentos agendamentoImportado : JIFUmaAgenda.listaAgendamentoCanceladoPorUltimo) {
                ...
                if(!"   .   .   -  ".equals(agendamentoImportado.getCpfPaciente())) jTFCpfPaciente.setText(agendamentoImportado.getCpfPaciente());
                try{
                   if(!"  /  /    ".equals(String.valueOf(agendamentoImportado.getNascimento()))) jTFNascimento.setText(MetodosUteis.converterDataParaMostrarAoUsuario(agendamentoImportado.getNascimento().toString())); 
                }catch(Exception e){
                    
                }
                if(!"(  )     -    ".equals(agendamentoImportado.getTelefone())) jTFTelefone.setText(agendamentoImportado.getTelefone());
                telefonePacienteSelecionado = jTFTelefone.getText();
                if(!"(  )     -    ".equals(agendamentoImportado.getCelular())) jTFCelular.setText(agendamentoImportado.getCelular());
                celularPacienteSelecionado = jTFCelular.getText();
                ...
                jtfDuracaoAgendamento.setText(MetodosUteis.transformarMinutosEmHorario(agendamentoImportado.getDuracaoAgendamento()));
                ...
                if(agendamentoImportado.getNomeExame()!=null){
                    ...
                    double valorDoExame;
                    calculoValorDeExame calculoValorExame;
                    if("CM".equals(agendamentoImportado.getMaterial()) || "CC".equals(agendamentoImportado.getMaterial())){
                        calculoValorExame = new calculoValorDeExame(agendamentoImportado.getHANDLE_CONVENIO(), agendamentoImportado.getHANDLE_EXAME(), dataDoExame, true);
                    }else{
                        calculoValorExame = new calculoValorDeExame(agendamentoImportado.getHANDLE_CONVENIO(), agendamentoImportado.getHANDLE_EXAME(), dataDoExame, false);
                    }
