...
public final class JIFUmaAgenda extends javax.swing.JInternalFrame {
    ...
    public Icon iconeAgendado = new ImageIcon (getClass().getResource("/menu/atendimentos/agenda/internalFrames/menuAgendar.png" ));
    public Icon iconeAgendadoExt = new ImageIcon ( getClass().getResource("/menu/atendimentos/agenda/imagens/menuAgendarExtendido.png" ));
    public Icon iconeAtendimento = new ImageIcon (getClass().getResource("/menu/atendimentos/agenda/imagens/menuAtendimento.png" ));
    public Icon iconeAtendmentoExt = new ImageIcon ( getClass().getResource("/menu/atendimentos/agenda/imagens/menuAtendimentoExtendido.png" ));
    ...
    public void montandoAsDatasNaAgenda(){
        ...
        jTable4.getColumnModel().getColumn(0).setHeaderValue(verificandoProximaData( (String) jTable3.getColumnModel().getColumn(0).getHeaderValue())); 
        
        //colocando data na tabela 5
        
        jTable5.getColumnModel().getColumn(0).setHeaderValue(verificandoProximaData( (String) jTable4.getColumnModel().getColumn(0).getHeaderValue())); 

        
        //colocando data na tabela 6
        
        jTable6.getColumnModel().getColumn(0).setHeaderValue(verificandoProximaData( (String) jTable5.getColumnModel().getColumn(0).getHeaderValue())); 
    ...
    public void negritoNoDiaDeHoje (){
        try{
            ...
            Date diaDaTabela2 = formatador.parse(String.valueOf(jTable2.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14));
            Date diaDaTabela3 = formatador.parse(String.valueOf(jTable3.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14));
            Date diaDaTabela4 = formatador.parse(String.valueOf(jTable4.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14));
            Date diaDaTabela5 = formatador.parse(String.valueOf(jTable5.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14));
            Date diaDaTabela6 = formatador.parse(String.valueOf(jTable6.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14));
    ...
    public void VerificandoHorariosEDiasDaAgenda (){
        ...
        int horarioFinalDaAgendaTurno1 = 0, horarioFinalDaAgendaTurno2 = 0, horarioFinalDaAgendaTurno3 = 0, horarioFinalDaAgendaTurno4 = 0;
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher a Agenda. Procure o administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            Conexao.fechaConexao(con);
        }
        

        construindoAsLinhasDaTabelaDeAcordoComAAgenda(jTable2, horarioDeInicioTurno1, horarioFinalDaAgendaTurno1, duracaoTurno1, horarioDeInicioTurno2, horarioFinalDaAgendaTurno2, duracaoTurno2, horarioDeInicioTurno3, horarioFinalDaAgendaTurno3, duracaoTurno3, horarioDeInicioTurno4, horarioFinalDaAgendaTurno4, duracaoTurno4);
        construindoAsLinhasDaTabelaDeAcordoComAAgenda(jTable3, horarioDeInicioTurno1, horarioFinalDaAgendaTurno1, duracaoTurno1, horarioDeInicioTurno2, horarioFinalDaAgendaTurno2, duracaoTurno2, horarioDeInicioTurno3, horarioFinalDaAgendaTurno3, duracaoTurno3, horarioDeInicioTurno4, horarioFinalDaAgendaTurno4, duracaoTurno4);
        construindoAsLinhasDaTabelaDeAcordoComAAgenda(jTable4, horarioDeInicioTurno1, horarioFinalDaAgendaTurno1, duracaoTurno1, horarioDeInicioTurno2, horarioFinalDaAgendaTurno2, duracaoTurno2, horarioDeInicioTurno3, horarioFinalDaAgendaTurno3, duracaoTurno3, horarioDeInicioTurno4, horarioFinalDaAgendaTurno4, duracaoTurno4);
        construindoAsLinhasDaTabelaDeAcordoComAAgenda(jTable5, horarioDeInicioTurno1, horarioFinalDaAgendaTurno1, duracaoTurno1, horarioDeInicioTurno2, horarioFinalDaAgendaTurno2, duracaoTurno2, horarioDeInicioTurno3, horarioFinalDaAgendaTurno3, duracaoTurno3, horarioDeInicioTurno4, horarioFinalDaAgendaTurno4, duracaoTurno4);
        construindoAsLinhasDaTabelaDeAcordoComAAgenda(jTable6, horarioDeInicioTurno1, horarioFinalDaAgendaTurno1, duracaoTurno1, horarioDeInicioTurno2, horarioFinalDaAgendaTurno2, duracaoTurno2, horarioDeInicioTurno3, horarioFinalDaAgendaTurno3, duracaoTurno3, horarioDeInicioTurno4, horarioFinalDaAgendaTurno4, duracaoTurno4);
    ...
    public void construindoAsLinhasDaTabelaDeAcordoComAAgenda (JTable tabela, int horarioDeInicioTurno1, int horarioFinalDaAgendaTurno1, int duracaoTurno1, int horarioDeInicioTurno2, int horarioFinalDaAgendaTurno2, int duracaoTurno2, int horarioDeInicioTurno3, int horarioFinalDaAgendaTurno3, int duracaoTurno3, int horarioDeInicioTurno4, int horarioFinalDaAgendaTurno4, int duracaoTurno4){
        //contruindo turno 1
    ...
    public void verificandoOsFeriadosDaAgenda(int handle_agenda){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel verificar Feriados desta Agenda. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        Conexao.fechaConexao(con);
    }
    ...
    public void verificandoOsIntervalosPorHorarioDaAgenda   (int idAgenda){
        boolean seg = false , ter = false, qua = false, qui = false, sex = false, sab = false, dom = false;
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel verificar Intervalos por Horário desta Agenda. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        Conexao.fechaConexao(con);
    }
    public void marcandoFlagNosIntervalosPorHorario     (String diaDaSemanaDoIntervalo, int horarioInicialDoIntervalo, int horarioFinalDoIntervalo){
        ...
        if(diaDaTabela2.equals(dia)){
            ...
            while(i<numeroDeLinhasDaTabela){
                ...
                int minutosLinha0 = Integer.valueOf(MetodosUteis.transformarHorarioEmMinutos( (String) jTable1.getValueAt(0, 0) ));
                int minutosLinha1 = Integer.valueOf(MetodosUteis.transformarHorarioEmMinutos( (String) jTable1.getValueAt(1, 0) ));
    ...
    public void verificandoOsIntervalosDiarios(int idAgenda){
        ...
        con = Conexao.fazConexao();
        ResultSet resultSet = intervalosDiariosDAO.getConsultarIntervalosDiarios(con, idAgenda);
        try{
            while(resultSet.next()){               
                horarioInicial = resultSet.getInt("HORARIOINICIAL");
                horarioFinal = resultSet.getInt("HORARIOFINAL");
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel verificar Intervalos Diários desta Agenda. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        Conexao.fechaConexao(con);
        
    }
    public void marcandoFlagNosIntervalosDiarios   (String diaDoIntervalo, int horaInicialDoIntervalo, int horaFinalDoIntervalo){    
    ...
    public void verificarIntervalosPorPeriodo(int idAgenda){
        ...
        //verificando intervalos diarios dessa agenda
        con = Conexao.fazConexao();
        ResultSet resultSet = intervalosPorPeriodoDAO.getConsultarIntervalosPorPeriodo(con, idAgenda);
        try{
            while(resultSet.next()){               
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Não foi possivel verificar Intervalos por Período desta Agenda. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
                }
                //marcandoFlagNosIntervalosDiarios(diaDoIntervaloString, horarioInicial, horarioFinal);
            } 
        }catch(SQLException e){
    ...
    public void marcandoFlagNosIntervalosPorPeriodo    (int horarioInicial, int horarioFinal, Date dataInicial, Date dataFinal){
    ...
    public static void preenchendoOsAgendamentosDestaAgenda  (JTable tabelaSelecionada, Icon iconeAgendamento, Icon iconeAgendamentoExt, Connection con)   {
        ...
        try {
            String diaDaTabela = String.valueOf(tabelaSelecionada.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14);
        ...
        try{
            while(resultSet.next()){
                ...
                marcandoNomeNaLinhaDoAgendamento(tabelaSelecionada,resultSet.getString("nomePaciente"),resultSet.getInt("handle_ap"),resultSet.getInt("hora"), iconeAgendamento, iconeAgendamentoExt, resultSet.getInt("duracaoDoAgendamento"));
            }          
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher os Agendamentos. Procure o administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    public static void marcandoNomeNaLinhaDoAgendamento(JTable tabelaSelecionada, String nomePaciente, int handle_ap, int horarioDoAgendamento ,Icon iconeAgendamento, Icon iconeAgendamentoExt, int duracaoDoAgendamento){
        
           //precorrendo as linhas da tabela
            for(int i = 0; i < tabelaSelecionada.getRowCount(); i++){
                try{
                    //se linha for no mesmo horario inicial do agendamento && nao eh um atendimento "4", marca ele na linha e percorre as proximas (para pintar se necessario)
                    if(MetodosUteis.transformarHorarioEmMinutos((String)jTable1.getValueAt(i, 0)) == horarioDoAgendamento && !"4".equals((String)tabelaSelecionada.getValueAt(i, 3)) && !"1".equals((String)tabelaSelecionada.getValueAt(i, 3))){
                        ...
                        if(!"*".equals(nomePaciente.toUpperCase())){
                            marcandoFlagDePinturaNasProximasLinhas(tabelaSelecionada, duracaoDoAgendamento, horarioDoAgendamento, i, iconeAgendamentoExt);
    ...
    public static void marcandoFlagDePinturaNasProximasLinhas      (JTable tabelaSelecionada, int duracaoDoAgendamento, int horarioInicioDoAgendamento, int linhaDoAgendamento, Icon iconeAgendamentoExt){
        for(int i = 0; i < tabelaSelecionada.getRowCount(); i++){
            //try e catch para se a linha for intervalo passar para a proxima (pq dara erro)
                try{
                    ...
                    int horarioDaLinhaEmminutos = MetodosUteis.transformarHorarioEmMinutos((String)JIFUmaAgenda.jTable1.getValueAt(i, 0));
                    int finalDoAgendamento = horarioInicioDoAgendamento + duracaoDoAgendamento;
                    
                    //if(se horario da linha for menor que o final do agendamento e maior que o inicio) entra pq a linha afeta esse agendamento
    ...
    public static void preenchendoOsAtendimentosDestaAgenda   (JTable tabelaSelecionada, Icon iconeAtendimento, Icon iconeAtendimentoExt, Connection con)   {
        ...
        for(int i =  0; i < numeroDeLinhasDaTabela; i++){
            ...
            //if para nao tirar o flag de pintura de intervalos!!!! "1" intervalo ou agenda nao funciona e "2" troca de turno
            if(!"1".equals((String)tabelaSelecionada.getValueAt(i, 3)) && !"2".equals((String)tabelaSelecionada.getValueAt(i, 3))){
                tabelaSelecionada.setValueAt("", i, 3);
            }
        ...
        try{
            while(resultSet.next()){
                ...
                for(int i = 0; i < tabelaSelecionada.getRowCount(); i++){
                    try {
                        if(MetodosUteis.transformarHorarioEmMinutos((String)jTable1.getValueAt(i, 0)) == resultSet.getInt("hora_atendimento")){
                            ...
                            //colocando icone 
                            int horaLinha = MetodosUteis.transformarHorarioEmMinutos(String.valueOf(jTable1.getValueAt(i, 0)));
                            int finalDoAtendimento = resultSet.getInt("duracao_atendimento") + horaLinha;
                            try {
                                if(finalDoAtendimento <= MetodosUteis.transformarHorarioEmMinutos(String.valueOf(jTable1.getValueAt(i+1, 0)))){
                                    // se o final agendamento for menor ou igual a hora da proxima linha ele coloca icone normal se nao coloca icone extendido
            ...
            while(resultSetReservas.next()){
                ...
                for(int i = 0; i < tabelaSelecionada.getRowCount(); i++){
                    try {
                        if(MetodosUteis.transformarHorarioEmMinutos((String)jTable1.getValueAt(i, 0)) == resultSetReservas.getInt("hora_atendimento")){
                            //marcando flag de sttatus 2 pq eh um atendimento
                            tabelaSelecionada.setValueAt("2", i, 2);
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher os Atendimentos. Procure o administrador." + e,"ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Dia", "Status", "Flag Status", "Flag Pintura", "HANDLE_AP", "HANDLE_AT"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Dia", "Status", "Flag Status", "Flag Pintura", "HANDLE_AP", "HANDLE_ATENDIMENTO"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 439, Short.MAX_VALUE)
    ...
    public void abrirPopUpDadosDoAgendamento(MouseEvent evt, JTable tabelaSelecionada){
        ...
        for(A_Agendamentos agendamento : listaAgendamentosDaAgenda){
            if(agendamento.getHANDLE_AP() == Integer.valueOf(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 4)))){
                ...
                listaDeExamesDoAgendamento.add(agendamento.getNomeExame() + "   -   Lado: " + agendamento.getLado() + "   -   Material: " + agendamento.getMaterial());
                finalDoAgendamento = MetodosUteis.transformarMinutosEmHorario(agendamento.getHORA() + agendamento.getDuracaoAgendamento());
                duracaoTotal = "Duração Total                : " + MetodosUteis.transformarMinutosEmHorario(agendamento.getDuracaoAgendamento());
                dia = "Dia                                   : " + MetodosUteis.converterDataParaMostrarAoUsuario(agendamento.getDia().toString());
                hora = "Horário                            : " + MetodosUteis.transformarMinutosEmHorario(agendamento.getHORA());
            }
        }
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        try{
            //inf para nao abrir o pop up caso seja a linha do intervalo ou a agenda nao esteja liberada nesta data e hora
            ...
            if(evt.getButton() != MouseEvent.BUTTON3 && colunaClicada == 1 && (linhaClicada==linhaSelecionada) && !"*".equals(String.valueOf(jTable2.getValueAt(jTable2.getSelectedRow(), 0)))){
                ...
                //try para se nao tiver handle_ap nao fazer nada
                try{
                    if(Integer.valueOf(String.valueOf(jTable2.getValueAt(jTable2.getSelectedRow(), 5))) > 0 && !"".equals(String.valueOf(jTable2.getValueAt(jTable2.getSelectedRow(), 0)))){
    ...
    private void jTable6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable6MouseClicked
        try {
            ...
            //abrindo popup de informações do atendimento ou agendamento
            if(evt.getButton() != MouseEvent.BUTTON3 && colunaClicada == 1 && (linhaClicada==linhaSelecionada) && !"*".equals(String.valueOf(jTable6.getValueAt(jTable6.getSelectedRow(), 0)))){
                //se tiver handle_ap abre dados do agendamento
                //try para se nao tiver handle_ap nao fazer nada
                try{
                ...
                //try para se nao tiver handle_ap nao fazer nada
                try{
                    if(Integer.valueOf(String.valueOf(jTable6.getValueAt(jTable6.getSelectedRow(), 5))) > 0 && !"".equals(String.valueOf(jTable6.getValueAt(jTable6.getSelectedRow(), 0)))){
    ...
    private void jTable5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable5MouseClicked
        try {
            ...
            //abrindo popup de informações do atendimento ou agendamento
            if(evt.getButton() != MouseEvent.BUTTON3 && colunaClicada == 1 && (linhaClicada==linhaSelecionada) && !"*".equals(String.valueOf(jTable5.getValueAt(jTable5.getSelectedRow(), 0)))){
                //se tiver handle_ap abre dados do agendamento
                //try para se nao tiver handle_ap nao fazer nada
                try{
                ...
                //try para se nao tiver handle_ap nao fazer nada
                try{
                    if(Integer.valueOf(String.valueOf(jTable5.getValueAt(jTable5.getSelectedRow(), 5))) > 0 && !"".equals(String.valueOf(jTable5.getValueAt(jTable5.getSelectedRow(), 0)))){
    ...
    private void jTable4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable4MouseClicked
        try {
            ...
            //abrindo popup de informações do atendimento ou agendamento
            if(evt.getButton() != MouseEvent.BUTTON3 && colunaClicada == 1 && (linhaClicada==linhaSelecionada) && !"*".equals(String.valueOf(jTable4.getValueAt(jTable4.getSelectedRow(), 0)))){
                //se tiver handle_ap abre dados do agendamento
                //try para se nao tiver handle_ap nao fazer nada
                try{
                ...
                //try para se nao tiver handle_ap nao fazer nada
                try{
                    if(Integer.valueOf(String.valueOf(jTable4.getValueAt(jTable4.getSelectedRow(), 5))) > 0 && !"".equals(String.valueOf(jTable4.getValueAt(jTable4.getSelectedRow(), 0)))){
    ...
    private void jTable3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable3MouseClicked
        try {
            ...
            //abrindo popup de informações do atendimento ou agendamento
            if(evt.getButton() != MouseEvent.BUTTON3 && colunaClicada == 1 && (linhaClicada==linhaSelecionada) && !"*".equals(String.valueOf(jTable3.getValueAt(jTable3.getSelectedRow(), 0)))){
                //se tiver handle_ap abre dados do agendamento
                //try para se nao tiver handle_ap nao fazer nada
                try{
                ...
                //try para se nao tiver handle_ap nao fazer nada
                try{
                    if(Integer.valueOf(String.valueOf(jTable3.getValueAt(jTable3.getSelectedRow(), 5))) > 0 && !"".equals(String.valueOf(jTable3.getValueAt(jTable3.getSelectedRow(), 0)))){
    ...
    public void abrirPopUp (final JTable tabelaSelecionada,  final java.awt.event.MouseEvent evt){
        ...
        //icones do popup
        ImageIcon iconeAgendar = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/menuAgendar.png")); 
        ImageIcon iconeRegistrarEntrada = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/menuAtendimento.png")); 
        ...
        if (evt.getButton() == MouseEvent.BUTTON3 && liberarPopUp) {
            ...
            try{
                ...
                if(Integer.valueOf(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 4))) > 0 && tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 0) != "*"){
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    SwingWorker worker = new SwingWorker(){
                                ...
                                protected Object doInBackground() throws Exception {
                                    ...
                                    String flagPintura = String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 3));
                                    String nome = String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 0));
                                    //atualizando a tabela
                                    preenchendoOsAtendimentosDeTodasAsTabelas();
                                    preenchendoOsAgendamentosDeTodasAsTabelas();

                                    //verificando se mudou os dados da linha
                                    String flagPinturaAtualizado = String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 3));
                                    String nomeAtualizado = String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 0));


                                    // verifico a cor para se mudar de nada para agendamento ou para atendimento e o nome para caso tenha algo 
            ...
            try{
                //se tive um agendamento e ele nao for um reservado *
                if(Integer.valueOf(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 5))) > 0 && tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 0) != ""){
            ...
            //if bloquear o menu 1 (agendar) se nao for nulo, vazio ou 1 o flag do status (pq significada q ja foi feita entrada de ficha)
            String flagDaLinhaSelecionada = (String) tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 2);
            if(!"".equals(flagDaLinhaSelecionada) && flagDaLinhaSelecionada !=null && !"1".equals(flagDaLinhaSelecionada)){
            ...
            try {
                ...
                if("".equals(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 0))) && Integer.valueOf(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow(), 5))) > 0){
                    menuRegistrarEntrada.setEnabled(false);
                    menuRegistrarEntrada.setText("Atendimento Reservado");
                    menuAgendar.setVisible(false);
                }
            ...
            try{
                ...
                Date diaDaTabelaSelecionada = formatador.parse(String.valueOf(tabelaSelecionada.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14));
    ...
    public void abrindoItemDoMenu1(JTable tabela) {
        ...
        try{
            handle_apDaLinhaSelecionada = Integer.valueOf(String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 4)));
        }catch(Exception e){
        }
        ...
        if("3".equals(String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 3))) && "".equals(String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 0)))){
            int resposta = JOptionPane.showConfirmDialog(null, "Já existe um agendamento neste horário. Deseja continuar?", "Atenção", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            //se resposta for sim abre o agendamento   
            if(resposta == JOptionPane.YES_OPTION){
                //sumindo legenda da agenda
                JIFAgendaPrincipal.sumirLegenda(false);
                
                janelaPrincipal.internalFrameAgendamento = new JIFAgendamento(livreOuOcupado, handle_apDaLinhaSelecionada, handle_agenda, tabela, this);
    ...
    public void abrindoItemDoMenu2(JTable tabela){
        ...
        try{
            handle_atDaLinhaSelecionada = Integer.valueOf(String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 5)));
        }catch(Exception e){
        }
        ...
        if("3".equals(String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 3))) && "".equals(String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 0)))){
            ...
            if(resposta == JOptionPane.YES_OPTION){
                ...
                JIFAgendaPrincipal.jDesktopPane1.setSize(JIFAgendaPrincipal.jDesktopPane1.getWidth(), JIFAgendaPrincipal.jDesktopPane1.getHeight() + 20);
                
                janelaPrincipal.internalFrameAtendimentoAgenda = new JIFAtendimentoAgenda(livreOuOcupado, handle_atDaLinhaSelecionada, handle_agenda, tabela, this);
                ...
                janelaPrincipal.internalFrameAtendimentoAgenda.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2);
