package menu.atendimentos.agenda.pinturaDeUmaAgenda;
  ...
  public Component getTableCellRendererComponent(JTable table, Object value,boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (isSelected) {
            ...
            if (row % 2 == 0) {
                ...
                if(("".equals(flagDePintura) || "null".equals(flagDePintura) || flagDePintura == null) && (!"1".equals(flagDePintura) && !"2".equals(flagDePintura))){
                    foreground = Color.BLACK;
