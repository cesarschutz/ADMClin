package menu.atendimentos.agenda.atendimentos.internalFrames;
...
public class JIFAtendimentoAgenda extends javax.swing.JInternalFrame {
    ...
    //variaveis de controle dos exames
    private List<Integer> listaDeAtendimento_exame_idParaSeremApagados = new ArrayList<Integer>();
    private int handleConvenioAntigo = 0;
    
    /**
     * Creates new form JIFagendamento
     */
    public JIFAtendimentoAgenda(String horarioLivreOuOcupado, int handle_at, int handle_agenda, JTable tabelaSelecionada, JInternalFrame internalFrame) {
        ...
        if("livre".equals(horarioLivreOuOcupado)){
            ...
            //bloquando o menu (pq fizemos uma reserva nos agendamentos e soh vai deletar a reservar ao salvar o agendamento ou cancelar
        ...
        if (handle_ap != 0) {
            ...
            try{
                while(resultSet.next()){
                    ...
                    if(handle_paciente > 0) jTFHANDLE_PACIENTE.setText(String.valueOf(handle_paciente));
                    ...
                    //isso para se mudar o convenio zerar a tabela e garantir que nao va colocar dois exame de convenios diferentes
                    if(primeiraVezNoFor){
                    ...
                    jtfDuracaoAtendimento.setText(MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("duracaoDoAgendamento")));
                    ...
                    String dataString = String.valueOf(tabelaSelecionada.getColumnModel().getColumn(0).getHeaderValue()).substring(4,14);  
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(null, "Não foi possível verificar a data do exame, o mesmo será calculado com a data atual!","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
                    }
                    ...
                    if("CM".equals(resultSet.getString("material")) || "CC".equals(resultSet.getString("material"))){
                        calculoValorExame = new calculoValorDeExame(resultSet.getInt("handle_convenio"), resultSet.getInt("handle_exame"), dataDoExame, true, porcentagemDeDesconto);
                    }else{
                        calculoValorExame = new calculoValorDeExame(resultSet.getInt("handle_convenio"), resultSet.getInt("handle_exame"), dataDoExame, false,porcentagemDeDesconto);
                    }

                    //adicionando na tabela o exame com o valor calculo de acordo com a data!!!
                    modelo.addRow(new Object[] {Integer.toString(resultSet.getInt("handle_exame")),resultSet.getString("nomeExame"),MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("duracaoDoExame")),MetodosUteis.colocarZeroEmCampoReais(calculoValorExame.valor_correto_exame), "", "",calculoValorExame.chConvenio,calculoValorExame.filmeConvenio,calculoValorExame.ch1Exame,calculoValorExame.ch2Exame,calculoValorExame.filmeExame, "",calculoValorExame.redutor,calculoValorExame.porcentDescontoPaciente,calculoValorExame.porcentConvenio,calculoValorExame.porcentPaciente,calculoValorExame.valorExame,calculoValorExame.valorConvenio,calculoValorExame.valorPaciente,calculoValorExame.valor_correto_convenio,calculoValorExame.valor_correto_paciente, calculoValorExame.valor_desconto});
                ...
                this.dispose();
                JOptionPane.showMessageDialog(null, "Não foi possivel preencher os dados do Agendamento. Procure o administrador." + e,"ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void preenchendoOsCamposDoAtendimentoCasoForEditarUmAtendimento(){
        ...
        try {
            while(resultSet.next()){
                ...
                jtfHoraEntregaExame.setText(MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("hora_exame_pronto")));
                jTAObservacao.setText(resultSet.getString("observacao"));
                ...
                for(int x=0; x < listaHandleConvenio.size(); x++){
                    if(listaHandleConvenio.get(x) == resultSet.getInt("handle_convenio")){
                        jCBConvenio.setSelectedIndex(x);
                        handleConvenioAntigo = resultSet.getInt("handle_convenio");
                        jCBModalidade.setSelectedItem(resultSet.getString("modalidade"));
                    }
                }
                ...
                jtfDuracaoAtendimento.setText(MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("duracao_atendimento")));
            ...
            while(resultSetExames.next()){
                modelo.addRow(new String[] {Integer.toString(resultSetExames.getInt("handle_exame")),
                    resultSetExames.getString("nomeExame"),
                        ...
                        resultSetExames.getString("valor_correto_exame"), 
                        resultSetExames.getString("lado"),
                        resultSetExames.getString("material"),
                        resultSetExames.getString("ch_convenio"),
                        resultSetExames.getString("filme_convenio"),
                        resultSetExames.getString("ch1_exame"),
                        resultSetExames.getString("ch2_exame"),
                        resultSetExames.getString("filme_exame"),
                        resultSetExames.getString("lista_materiais"),
                        resultSetExames.getString("redutor"),
                        resultSetExames.getString("desconto_paciente"),
                        resultSetExames.getString("porcentagem_convenio"),
                        resultSetExames.getString("porcentagem_paciente"),
                        resultSetExames.getString("valor_exame"),
                        resultSetExames.getString("valor_convenio"),
                        resultSetExames.getString("valor_paciente"),
                        resultSetExames.getString("valor_correto_convenio"),
                        resultSetExames.getString("valor_correto_paciente"),
                        resultSetExames.getString("valor_desconto"),
    ...
    /*
     * Este metodo bloqueia as opções de edição de um exame, isso ocorre quando o atendente ja imprimiu algo ou algum dos exames ja possui laudo.
     */
    ...
    /*
     * este metodo é chamado quando vamos editar um atendimento apartir da janela de pesquisa de atendimentos, e nao da agenda (por isos possue algumas alterações)
     */
    //variavel para que se flag imprimiu vem marcado, quando salvar salva S 
    boolean flag_imprimu = false;
    public void preenchendoOsCamposDoAtendimentoCasoForEditarUmAtendimentoQuandoVemDaPesquisaDeAtendimentos(int handle_at, String hora, String data){        
        //buscando as informações do atendimento
    ...
    public void preenchendoAsModalidades (){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possível preencher as Modalidades da Agenda. Procure o administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    //ok
    public void botaoPesquisarPaciente(){
        ...
        if(jTFPaciente.getText().length() >= 3){
            ...
            if (veioDaPesquisa) {
                ...
                janelaPrincipal.internalFrameAtendimentoSelecionarUmPaciente.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2);
    ...
    public void botaoPesquisarMedicoSolicitante(){
        ...
        if(jTFMedicoSol.getText().length() >= 3){
            ...
            if (veioDaPesquisa) {
                ...
                janelaPrincipal.internalFrameAtendimentoSelecionarUmMedicoSolicitante.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2);
            }else{
                JIFAgendaPrincipal.jDesktopPane1.add(janelaPrincipal.internalFrameAtendimentoSelecionarUmMedicoSolicitante);
                janelaPrincipal.internalFrameAtendimentoSelecionarUmMedicoSolicitante.setVisible(true);
    ...
    private boolean verificarSeMatriculaEValida(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possível verificar o Modelo de Validação da Matrícula. Procure o administrador","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
            Conexao.fechaConexao(con);
            return false;
        }
        Conexao.fechaConexao(con);
        ...
        if (modeloDeValidacaoMatricula == 0) {
            ...
            if (!matriculaValida) {
                jTFMensagemParaUsuario.setForeground(new java.awt.Color(255, 0, 0));
                jTFMensagemParaUsuario.setText("Matrícula Inválida, verifique se a matrícula foi digitada corretamente.");
            }
    ...
    public void botaoSalvar   (){
        ...
        if(verificarSeFoiTudoPreenchido() && verificarSeMatriculaEValida()){
            ...
            if(handle_at>0){                
                ...
                JOptionPane.showMessageDialog(janelaPrincipal.internalFrameJanelaPrincipal, "Erro ao cadastrar atendimento.Procure o Administrador.", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public boolean verificarSeHaTempoParaRealizarOAtendimento(){
        try{
            ...
            int minutosLinha0 = MetodosUteis.transformarHorarioEmMinutos((String) JIFUmaAgenda.jTable1.getValueAt(0, 0));
            int minutosLinha1 = MetodosUteis.transformarHorarioEmMinutos(String.valueOf(JIFUmaAgenda.jTable1.getValueAt(1, 0)));
            ...
            //se nao existirem linhas (horarios) suficientes ou o flag status for diferente de nulo ou "" ou a pintura for de umintervalo qualuqer
            ...
            for(int i = linhaSelecionada; i < linhaSelecionada+qtdDeHorariosQueOcuparaDaAgenda;i++){
                ...
                if(!"null".equals(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow()+j, 0))) && !"".equals(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow()+j, 0))) && !"*".equals(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow()+j, 0)))){
                    return false;
                }
                ...
                if(("1".equals(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow()+j, 3))) || "2".equals(String.valueOf(tabelaSelecionada.getValueAt(tabelaSelecionada.getSelectedRow()+j, 3))))){
                    return false;
                }
    ...
    public void atualizarTabelasDaAgenda(){
        //atualizando a janela de uma agenda
                Icon iconeAgendado = new ImageIcon (getToolkit().createImage( getClass().getResource("/menu/atendimentos/agenda/imagens/menuAgendar.png" )));
                Icon iconeAgendadoExt = new ImageIcon (getToolkit().createImage( getClass().getResource("/menu/atendimentos/agenda/imagens/menuAgendarExtendido.png" )));
                ...
                Icon iconeAtendmentoExt = new ImageIcon (getToolkit().createImage( getClass().getResource("/menu/atendimentos/agenda/imagens/menuAtendimentoExtendido.png" )));
                JIFUmaAgenda.listaAgendamentosDaAgenda.clear();
                con = Conexao.fazConexao();
                JIFUmaAgenda.preenchendoOsAtendimentosDestaAgenda(JIFUmaAgenda.jTable2,iconeAtendimento,iconeAtendmentoExt, con);
                JIFUmaAgenda.preenchendoOsAtendimentosDestaAgenda(JIFUmaAgenda.jTable3,iconeAtendimento,iconeAtendmentoExt, con);
                JIFUmaAgenda.preenchendoOsAtendimentosDestaAgenda(JIFUmaAgenda.jTable4,iconeAtendimento,iconeAtendmentoExt, con);
                JIFUmaAgenda.preenchendoOsAtendimentosDestaAgenda(JIFUmaAgenda.jTable5,iconeAtendimento,iconeAtendmentoExt, con);
                JIFUmaAgenda.preenchendoOsAtendimentosDestaAgenda(JIFUmaAgenda.jTable6,iconeAtendimento,iconeAtendmentoExt, con);
    ...
    public void botaoAtualizar(){
        if (veioDaPesquisa) {
            ...
            //String de retorno quando verificou se nao ha tempo para o agendamento ou se ja existe um agendamento naquele horario
            String retorno = verificandoSeHaAlgumAgendamentoOuAtendimentoNaLinhaSelecionada();

            if(!"".equals(retorno)){
                int resposta = JOptionPane.showConfirmDialog(null, retorno, "Atenção", JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
    ...
    public void botaoIncluirExame (){
        if(jCBExame.isEnabled() && jCBExame.getSelectedIndex()!=0){
            ...
            String duracaoExame = MetodosUteis.transformarMinutosEmHorario(listaDuracaoExames.get(jCBExame.getSelectedIndex()));
            ...
            //pegando a data da tabela que foi clicado para pesquisar os valores dos exames com ela
                ...
                calculoValorDeExame calculoValorExame = new calculoValorDeExame(listaHandleConvenio.get(jCBConvenio.getSelectedIndex()),listaHandleExames.get(jCBExame.getSelectedIndex()), dataDoExame, false, porcentagemDeDesconto);
            ...
            modelo.addRow(new Object[] {handle_exame,nomeExame,duracaoExame,MetodosUteis.colocarZeroEmCampoReais(calculoValorExame.valor_correto_exame), "", "",
                chConvenio,filmeConvenio,ch1Exame,ch2Exame,filmeExame, "",calculoValorExame.redutor,calculoValorExame.porcentDescontoPaciente,
                calculoValorExame.porcentConvenio,calculoValorExame.porcentPaciente,calculoValorExame.valorExame,calculoValorExame.valorConvenio,
                calculoValorExame.valorPaciente,calculoValorExame.valor_correto_convenio,calculoValorExame.valor_correto_paciente, calculoValorExame.valor_desconto});
            calcularValoresApartirDaTabela();
            ...
            if(listaVaiMateriaisPorPadrao.get(jCBExame.getSelectedIndex()) == 1){
                ...
                if (jTable1.getValueAt(jTable1.getSelectedRow(), 16) != null || jTable1.getValueAt(jTable1.getSelectedRow(), 16) != "" || jTable1.getValueAt(jTable1.getSelectedRow(), 16) != "null") {
    ...
    public static void calcularValoresApartirDaTabela(){
        ...
        if (jTable1.getRowCount() > 0) {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                valorTotalExames = new BigDecimal(valorTotalExames + Double.valueOf(String.valueOf(jTable1.getValueAt(i, 3)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                //somando o valor convenio
                valorConvenio = new BigDecimal(valorConvenio + Double.valueOf(String.valueOf(jTable1.getValueAt(i, 19)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                //somando o valor paciente com desconto
                valorPacienteComDesconto = new BigDecimal(valorPacienteComDesconto + Double.valueOf(String.valueOf(jTable1.getValueAt(i, 20)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                ...
                //colocando a duração
                int duracaoDoExameSelecionado = MetodosUteis.transformarHorarioEmMinutos((String) jTable1.getValueAt(i, 2));
    ...
    private void initComponents() {
        ...
        jtfHoraEntregaExame = new JFormattedTextField(new ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("##:##"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Atendimento", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jTFDia, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jtfDuracaoAtendimento, javax.swing.GroupLayout.DEFAULT_SIZE, 66, Short.MAX_VALUE))
                            .addComponent(jTFAgenda, javax.swing.GroupLayout.DEFAULT_SIZE, 321, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfHoraEntregaExame, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jtfHoraEntregaExame, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFAgenda, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtfDuracaoAtendimento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel2)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Paciente", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        jBPesquisaPaciente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/Lupa.png"))); // NOI18N
        ...
        jBPesquisaMedico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/Lupa.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jTFMedicoSol, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTFHANDLE_MEDICO_SOL, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBPesquisaMedico, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel4)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jTFPaciente, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTFHANDLE_PACIENTE, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jBPesquisaPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jTFHANDLE_PACIENTE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(jBPesquisaPaciente, javax.swing.GroupLayout.DEFAULT_SIZE, 46, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jTFMedicoSol, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTFHANDLE_MEDICO_SOL, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(jBPesquisaMedico, javax.swing.GroupLayout.DEFAULT_SIZE, 46, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Exames do Atendimento", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "HANDLE EXAME", "Exame(s)", "Duração", "Valor", "Lado", "Material", "chConvenio", "filmeConvenio", "ch1Exame", "ch2Exame", "filmeExame", "lista de materiais", "redutor", "desconto_paciente", "porcentagem_convenio", "porcentagem_paciente", "valor_exame", "valor_convenio", "valor_paciente", "valor_correto_convenio", "valor_correto_paciente", "valor_desconto"
            }
        ) {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jBIncluirExame, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 418, Short.MAX_VALUE)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTFMatricula, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
                            .addComponent(jCBConvenio, 0, 349, Short.MAX_VALUE)
                            .addComponent(jTFComplemento, javax.swing.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel16)
                            .addComponent(jCBModalidade, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(jCBExame, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jBImprimirNotaFiscal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/imprimirNotaFiscal.png"))); // NOI18N
        ...
        jBImprimirBoletoDeRetirada.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/imrpimirBoletoRetirada.png"))); // NOI18N
        ...
        jBImprimirFicha.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/imprimirFicha.png"))); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jTBDesconto, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel20)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTFValorTotal, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel15)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTFValorPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel19)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTFValorConvenio, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(1, 1, 1))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel19)
                            .addComponent(jTFValorConvenio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel20)
                            .addComponent(jTFValorTotal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel15)
                            .addComponent(jTFValorPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTBDesconto)
                        .addGap(1, 1, 1))
                    .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(jBImprimirNotaFiscal, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jBImprimirBoletoDeRetirada, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jBImprimirFicha, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private boolean primeiraVezQueMecheuNosConvenios = true;
    ...
    public void preenchendoOsExames(){
        ...
        if(jCBConvenio.getSelectedIndex() != 0){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Não foi possivel preencher os Exames deste Convênio. Procure o administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
            }finally{
                Conexao.fechaConexao(con);
 ...
 botaoIncluirExame();        // TODO add your handling code here:
        ...
        if(jTable1.isEnabled()){
            if (evt.getButton() == MouseEvent.BUTTON3) {
                ...
                if (col != -1 && row != -1) {
                    ...
                    //abrindo o popUp
                    ImageIcon iconeCancelarLado = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/popUpCancelar.png")); 
                    ImageIcon iconDireito = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/popUpDireito.png")); 
                    ImageIcon iconEsquerdo = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/popUpEsquerdo.png")); 
                    ImageIcon iconCancelarContraste = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/popUpCancelarContraste.png")); 
                    ImageIcon iconComContraste = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/contrast.png")); 
                    ImageIcon iconComMaterial = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/materiais.png")); 
                    ImageIcon iconAlterarValorExame = new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/popUpAlterarValorDeExame.png")); 
                    ...
                    if(jTable1.getSelectedColumn() == 1){
                        JMenuItem menuAlterarValorDeExame = new JMenuItem("Alterar Valor de Exame", iconAlterarValorExame);
    ...
    private void alterarValorDeExame(){
        if (jTBDesconto.isSelected()) {
            retirarDesconto();
            JOptionPane.showMessageDialog(janelaPrincipal.internalFrameJanelaPrincipal, "Seu Desconto foi Cancelado, aplique novamente o Desconto caso necessario.");
        }
        ...
        janelaPrincipal.internalFrameAlterarValorDeExamesNoAtendimento = new jIFAlterarValorDeExame(nomeExame,jTable1.getSelectedRow(),porcentagem_convenio,porcentagem_paciente);
        ...
        if (veioDaPesquisa) {
            ...
            janelaPrincipal.internalFrameAlterarValorDeExamesNoAtendimento.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2);
        }else{
    ...
    public void mudarValorDeExameCasoMudeComMaterialOuComContraste(boolean somarValoresDeMateriais){
        ...
        String dataString = jTFDia.getText();
                ...
                calculoValorDeExame calculoValorExame;
           calculoValorExame = new calculoValorDeExame(listaHandleConvenio.get(jCBConvenio.getSelectedIndex()),Integer.valueOf(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(), 0))), dataDoExame, somarValoresDeMateriais, porcentagemDeDesconto); 
        ...
        ((DefaultTableModel) jTable1.getModel()).setNumRows(0);
         ...
         jCBExame.removeAllItems();
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Não foi possível preencher os Exames deste Convênio. Procure o administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
            }finally{
                Conexao.fechaConexao(con);
                jCBExame.setEnabled(true);
            }
    ...
    private void jTBDescontoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTBDescontoActionPerformed
        if (jTBDesconto.isSelected()) {
            ...
            if (jTable1.getRowCount() > 0) {
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                        double valorPacienteAntigo = new BigDecimal(Double.valueOf(String.valueOf(jTable1.getValueAt(i, 20)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valorCorretoConvenio = new BigDecimal(Double.valueOf(String.valueOf(jTable1.getValueAt(i, 19)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valorPacienteNovo = new BigDecimal(valorPacienteAntigo - (valorPacienteAntigo * (porcentagemDeDesconto/100))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valorCorretoExameNovo = new BigDecimal(valorPacienteNovo + valorCorretoConvenio).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        ...
                        double valor_desconto = new BigDecimal(valorPacienteAntigo - valorPacienteNovo).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
    ...
    public void retirarDesconto(){
        ...
        jTBDesconto.setText("Aplicar Desconto");
            ...
            if (jTable1.getRowCount() > 0) {
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                        double valorPaciente = new BigDecimal(Double.valueOf(String.valueOf(jTable1.getValueAt(i, 20)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valor_desconto = new BigDecimal(Double.valueOf(String.valueOf(jTable1.getValueAt(i, 21)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valor_paciente_novo = new BigDecimal(valorPaciente + valor_desconto).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valorCorretoConvenio = new BigDecimal(Double.valueOf(String.valueOf(jTable1.getValueAt(i, 19)))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double valorCorretoExameNovo = new BigDecimal(valor_paciente_novo + valorCorretoConvenio).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
    ...
    private void criarJoptionPaneParaDefinirAPorcentagemDeDesconto(){
       ...
       textField.setMaximumSize(tamanhoDoTextField);
        ...
        JOptionPane.showConfirmDialog(janelaPrincipal.internalFrameJanelaPrincipal, entUsuario, "Definir Desconto", JOptionPane.PLAIN_MESSAGE);
