...
public class jIFAlterarValorDeExame extends javax.swing.JInternalFrame {
    ...
    public jIFAlterarValorDeExame(String nomeExame, int linhaDaTabelaSelecionada, double porcentagem_convenio, double porcentagem_paciente) {
        initComponents();
    ...
    private void salvarValorExame(){
        ...
        valorExame = new BigDecimal(Double.valueOf(jTFValorExame.getText().replace(",", "."))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
        
        
        valorPaciente = new BigDecimal(valorExame * (porcentagem_paciente/100)).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
        valorConvenio = new BigDecimal(valorExame * (porcentagem_convenio/100)).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
    ...
    private void salvarValorConvenioPaciente(){
        ...
        double valorPaciente,valorConvenio,valorExame;
        valorPaciente = new BigDecimal(Double.valueOf(jTFValorPaciente.getText().replace(",", "."))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
        valorConvenio = new BigDecimal(Double.valueOf(jTFValorConvenio.getText().replace(",", "."))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Alterar Valor de Exame", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, null, java.awt.Color.black));

        jLabel1.setText("Alterar por");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Valor do Exame", "Valor do Convênio e do Paciente" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addComponent(jTFValorExame, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel4)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(jTFValorPaciente, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel3)
                                    .addGap(18, 18, 18)
                                    .addComponent(jTFValorConvenio, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))))))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(jTFValorExame, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jBOkExame3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private javax.swing.JButton jBOkExame1;
    private javax.swing.JButton jBOkExame2;
