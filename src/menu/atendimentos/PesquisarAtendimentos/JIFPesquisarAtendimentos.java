 ...
 */
package menu.atendimentos.PesquisarAtendimentos;
...
public class JIFPesquisarAtendimentos extends javax.swing.JInternalFrame {
    ...
    private void botaoPesquisarAtendimentos(String digitado){
        ...
        try {
            handle_at = Integer.valueOf(digitado);
            isNumber = true;
        } catch (Exception e) {
            isNumber = false;
        }
        ...
        if (isNumber) { 
            ...
            ResultSet resultSet = EditarAtendimentosDAO.getConsultarAtendimentosPorHandleAt(con, Integer.valueOf(digitado));
            try{
                ...
                for (int i = 0; i < listaAtendimentos.size(); i++) {
                    modelo.addRow(new Object[] {MetodosUteis.converterDataParaMostrarAoUsuario(listaAtendimentos.get(i).getData_atendimento()), listaAtendimentos.get(i).getHora(), listaAtendimentos.get(i).getHandle_at(), listaAtendimentos.get(i).getMod(),
                        listaAtendimentos.get(i).getPaciente(), listaAtendimentos.get(i).getMedico_solicitante(), listaAtendimentos.get(i).getCrm(), listaAtendimentos.get(i).getStatusA()});
                }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisar Atendimentos", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Data", "Hora", "Código", "Mod.", "Paciente", "Médico Solicitante", "CRM", "Status A."
            }
        ) {
        ...
        jBPesquisaPaciente2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/menu/atendimentos/agenda/imagens/Lupa.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jBPesquisaPaciente2, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jBPesquisaPaciente2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 493, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTFMensagemParaUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTFMensagemParaUsuario.requestFocusInWindow();     // TODO add your handling code here:
    ...
    ImageIcon iconeVisualizarAtendimento = new javax.swing.ImageIcon(getClass().getResource("/Imagens/imagemPesquisarInvertida.png"));
    ImageIcon iconeEditarAtendimento = new javax.swing.ImageIcon(getClass().getResource("/janelaPrincipal/imagensMenu/menuAtendimentoAtendimento.png"));
