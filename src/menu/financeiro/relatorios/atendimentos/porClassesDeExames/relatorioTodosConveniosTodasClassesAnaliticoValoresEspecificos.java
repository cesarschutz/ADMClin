 ...
 */
package menu.financeiro.relatorios.atendimentos.porClassesDeExames;
 ...
 * @author BCN
 */
public class relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificos {
    
    private Date dataInicial = null, dataFinal  = null;
    private String dataInicialString, dataFinalString;
    private Connection con = null;

    public relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificos(Date dataInicial, Date dataFinal) {
    ...
    public boolean gerarRelatorio(){
        try {
            ...
            JOptionPane.showMessageDialog(janelaPrincipal.janelaPrincipal.internalFrameJanelaPrincipal, "Erro ao elaborar Relatório. Procure o Administrador." + e);
            return false;
        } finally {
    ...
    public List<relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosMODEL> listaDeAtendimentos = new ArrayList<relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosMODEL>();
    private void consultarAtendimentos() throws SQLException{
        listaDeAtendimentos.removeAll(listaDeAtendimentos);
        ResultSet resultSet = relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosDAO.getConsultarAtendimentos(con, dataInicial, dataFinal);
        while(resultSet.next()){
            relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosMODEL atendimento = new relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosMODEL();
    ...
    public void criandoFatura() throws FileNotFoundException, DocumentException{
        ...
        PdfWriter.getInstance(document, new FileOutputStream(caminho + "relatórioTodosConvêniosTodasClassesDeExamesAnalíticoValoresEspecíficos.pdf"));
        document.open();
        ...
        //colocando o 
        cell = new PdfPCell(new Phrase("Relatório de Atendimentos Analítico com Valores Específicos por Classes de Exames", fontNegrito11));
     ...
     */
     private void abrirFichaPDF() throws IOException{
            ...
            if (OSvalidator.isWindows()) {
                runtime.exec("cmd /c \"" + caminho+ "relatórioTodosConvêniosTodasClassesDeExamesAnalíticoValoresEspecíficos.pdf");
            } else if(OSvalidator.isMac()){
                runtime.exec("open " + caminho + "relatórioTodosConvêniosTodasClassesDeExamesAnalíticoValoresEspecíficos.pdf");
            }else{
                 runtime.exec("gnome-open " + caminho + "relatórioTodosConvêniosTodasClassesDeExamesAnalíticoValoresEspecíficos.pdf");
            }
    }
}
