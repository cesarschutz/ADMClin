 ...
 * @author BCN
 */
public class relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosDAO {
     ...
     * @return ResultSet
     */
    public static ResultSet getConsultarAtendimentos(Connection con, Date diaInicial, Date diaFinal){
        ResultSet resultSet = null;
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select a.data_atendimento, e.handle_at, p.nome as nomePaciente, j.nome as nomeConvenio, x.nome as nomeExame, e.ch_convenio, e.filme_convenio, e.ch1_exame, e.ch2_exame, e.filme_exame, e.lista_materiais, c.nome as nomeClasseDeExame, e.redutor, e.valor_desconto, e.valor_correto_exame, e.material from atendimento_exames e " +
                ...
                "order by j.nome asc, a.data_atendimento asc, a.handle_at");
