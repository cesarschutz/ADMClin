 ...
 * @author BCN
 */
public class relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificosMODEL {
    ...
    public String getPaciente() {
        if (paciente.length() > 22) {
            paciente = paciente.substring(0,22);
        }
    ...
    public void setConvenio(String convenio) {
        if (convenio.length() > 13) {
            convenio = convenio.substring(0,13);
        }
