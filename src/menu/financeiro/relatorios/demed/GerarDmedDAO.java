...
public class GerarDmedDAO {
    ...
    public static ResultSet getConsultarDmed(Connection con, Date diaInicial, Date diaFinal){
        ...
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select e.handle_at, a.data_atendimento, e.valor_correto_paciente, p.nome, p.cpf, p.responsavel, p.cpfresponsavel from atendimento_exames e " +
            ...
            JOptionPane.showMessageDialog(null, "Erro ao consultar os Atendimentos Para gerar DMED. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
