...
public class faturaConvenio {
    ...
    //convenio
    public faturaConvenio(String tp, Date dataInicial, Date dataFinal, String nome, int handle_convenio, List<atendimentoModel> listaAtendimentos) {
    ...
    //grupo
    public faturaConvenio(String tp, Date dataInicial, Date dataFinal, String nome, int grupo_id, int x, List<atendimentoModel> listaAtendimentos) {
        this.dataInicial = dataInicial;
        this.dataFinal = dataFinal;
   ...
   String caminho = "";
    ...
    private void criandoAFatura() throws DocumentException, FileNotFoundException, SQLException{
        ...
        for (atendimentoModel atendimento : listaDeAtendimentos) {
            ...
            ResultSet resultSet;
            if (tipo.equals("grupo")) {
                resultSet = atendimentoDAO.getConsultarExamesDosAtendimento(con, atendimento.getHandle_at(), atendimento.getHandle_convenio());
            }else{
                resultSet = atendimentoDAO.getConsultarExamesDosAtendimento(con, atendimento.getHandle_at(), handle_convenio);
            }
            while(resultSet.next()){
                ...
                String nomeDoExame = resultSet.getString("cod_exame") + " - " + nomeModalidade(resultSet.getString("modalidade")) + " - " + resultSet.getString("sinonimo");
                ...
                double valor_total_exame = new BigDecimal(valor_correto_exame + valor_desconto).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                String valor_total_string = String.valueOf(valor_total_exame);
                
                 cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(valor_total_string).replaceAll("\\.", ","),font8));
                cell.setBorder(Rectangle.NO_BORDER);
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                tabelaExameDoAtendimento.addCell(cell);
                ...
                cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(resultSet.getString("valor_correto_convenio")).replaceAll("\\.", ","),font8));
                cell.setBorder(Rectangle.NO_BORDER);
                cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                tabelaExameDoAtendimento.addCell(cell);
                ...
                if (ch1_exame > 0 || ch2_exame > 0 ){
                    ...
                    //colocando O valor do ch (ch_convenio)
                        cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(resultSet.getString("ch_convenio")),font7));
                        cell.setBorder(Rectangle.NO_BORDER);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                        tabelaDeMaterialCH.addCell(cell);
                        ...
                        double quantidadeCh = new BigDecimal(Double.valueOf(resultSet.getString("ch1_exame")) + Double.valueOf(resultSet.getString("ch2_exame"))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(String.valueOf(quantidadeCh)),font7));
                        cell.setBorder(Rectangle.NO_BORDER);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                        tabelaDeMaterialCH.addCell(cell);
                    ...
                    //colocando o valor total do ch
                        ...
                        double valorTotalDoMaterialCH = new BigDecimal(Double.valueOf(resultSet.getString("ch_convenio")) * quantidadeCh).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(String.valueOf(valorTotalDoMaterialCH)),font7));
                        cell.setBorder(Rectangle.NO_BORDER);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                        tabelaDeMaterialCH.addCell(cell);
                ...
                if (filme_exame > 0){
                    ...
                    //colocando O valor do filme (filme_convenio)
                        cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(resultSet.getString("filme_convenio")),font7));
                        cell.setBorder(Rectangle.NO_BORDER);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                        tabelaDeMatrialFilme.addCell(cell);
                        ...
                        //double quantidade = new BigDecimal(Double.valueOf(resultSet.getString("filme_exame"))).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        double quantidade = Double.valueOf(MetodosUteis.colocarZeroEmCampoReais(resultSet.getString("filme_exame")));
                    ...
                    //colocando o valor total do filme
                        ...
                        double valorTotalDoMaterial = new BigDecimal(Double.valueOf(resultSet.getString("filme_convenio")) * quantidade).setScale(2, RoundingMode.HALF_EVEN).doubleValue();
                        cell = new PdfPCell(new Phrase(MetodosUteis.colocarZeroEmCampoReais(String.valueOf(valorTotalDoMaterial)),font7));
                        cell.setBorder(Rectangle.NO_BORDER);
                        cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
                        tabelaDeMatrialFilme.addCell(cell);
                ...
                if (!"".equals(resultSet.getString("lista_materiais")) && !"null".equals(resultSet.getString("lista_materiais")) && resultSet.getString("lista_materiais") != null ){
        ...
        String valorTotalString = String.valueOf(new BigDecimal(valorTotalConvenio).setScale(2, RoundingMode.HALF_EVEN).doubleValue());
        cell = new PdfPCell(new Phrase("Total: " + MetodosUteis.colocarZeroEmCampoReais(valorTotalString).replaceAll("\\.", ","), fontNegrito11));
        cell.setBorder(Rectangle.NO_BORDER);
        cell.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
