...
public class jIFFaturarConvenios extends javax.swing.JInternalFrame {
    ...
    private void buscandoOsAtendimentos(String tp, java.sql.Date dataInicial, java.sql.Date dataFinal, int handle) throws SQLException{
        ...
        if (verificarDatas()) {
           ...
           //pegando data Final
                        ...
                        try {
                            ...
                            janelaPrincipal.internalFrameAtendimentosParaFaturar = new jIFListaAtendimentosParaFaturar("convenio",diaInicialSql, diaFinalSql, 
                                    String.valueOf(jCBConvenios.getSelectedItem()), listaHandleConvenio.get(jCBConvenios.getSelectedIndex()), listaDeAtendimentos);
                            ...
                            janelaPrincipal.internalFrameAtendimentosParaFaturar.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2 - aIFrame / 2);
                            
                            
                        } catch (Exception e) {
                            JOptionPane.showMessageDialog(janelaPrincipal.internalFrameJanelaPrincipal, "Erro ao gerar Fatura.", "Erro", JOptionPane.ERROR_MESSAGE);
                        }
    ...
    public void botaoGerarFaturaGrupo(){
        ...
        if (verificarDatas()) {
           ...
           //pegando data Final
                        ...
                        try {
                            buscandoOsAtendimentos("grupo", diaInicialSql, diaFinalSql, listaGrupoId.get(jCBGrupos.getSelectedIndex()));
                            janelaPrincipal.internalFrameAtendimentosParaFaturar = new jIFListaAtendimentosParaFaturar("grupo",diaInicialSql, diaFinalSql, 
                                    String.valueOf(jCBGrupos.getSelectedItem()), listaGrupoId.get(jCBGrupos.getSelectedIndex()),0, listaDeAtendimentos);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Faturamento de Convênios", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jXDatePicker3, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jCBConvenios, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(jCBGrupos, javax.swing.GroupLayout.PREFERRED_SIZE, 304, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    ...
                    if (jRBGrupo.isSelected()) {
                        if (jCBGrupos.getSelectedIndex() !=0) {
                            botaoGerarFaturaGrupo(); 
                             ...
                             JOptionPane.showMessageDialog(janelaPrincipal.internalFrameJanelaPrincipal, "Selecione um Grupo.");
                         }
                    }else{
