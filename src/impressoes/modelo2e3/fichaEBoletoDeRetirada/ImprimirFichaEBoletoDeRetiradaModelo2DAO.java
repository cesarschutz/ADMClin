...
public class ImprimirFichaEBoletoDeRetiradaModelo2DAO {
    ...
    public static ResultSet getConsultarDadosDaFicha(Connection con, int handle_at){
        ...
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select distinct x.atendimento_exame_id, a.modalidade,a.data_exame_pronto,a.data_atendimento,a.hora_atendimento,a.duracao_atendimento,p.nome as nomePaciente,p.nascimento,p.peso,p.telefone,p.cidade,p.uf,p.altura,p.endereco,c.nome as nomeConvenio,m.nome as nomeMedico,e.nome as nomeExame " +
                                                                    "from atendimentos a " +
