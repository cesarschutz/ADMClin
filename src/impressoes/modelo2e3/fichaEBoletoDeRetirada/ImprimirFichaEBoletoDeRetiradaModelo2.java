...
public class ImprimirFichaEBoletoDeRetiradaModelo2 {
    ...
    private void imprimirCanhotoDeRetirada(){
        ...
        imprimir.print("                   " + arrumarTamanhoDaString(nomeModalidade(listaDeExames.get(0).getModalidade()), 21) + "   " + arrumarTamanhoDaString(listaDeExames.get(0).getDataEntregaExame(), 13) + "  " + arrumarTamanhoDaString(String.valueOf(handle_at), 9));
    ...
    private void imprimirFicha(){
        ...
        imprimir.print("    " + arrumarTamanhoDaString(String.valueOf(handle_at), 19) + "      " + arrumarTamanhoDaString(listaDeExames.get(0).getNomePaciente(), 38));
        ...
        imprimir.print("    " + arrumarTamanhoDaString(listaDeExames.get(0).getDataAtendimento(), 19) + "      " + arrumarTamanhoDaString(listaDeExames.get(0).getIdadePaciente(), 22) + "   " + arrumarTamanhoDaString(listaDeExames.get(0).getPesoPaciente(), 13));
        
        imprimir.lineFeed(); //vai para a linha 24
        imprimir.lineFeed(); //vai para a linha 25
        
        //imprimir hora marcada e telefone
        imprimir.print("        " + arrumarTamanhoDaString(listaDeExames.get(0).getHoraAtendimento(), 15) + "      " + arrumarTamanhoDaString(listaDeExames.get(0).getTelefonePaciente(), 38));
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (i==0) {
                ...
                imprimir.print("    " + arrumarTamanhoDaString(nomeDoExame, 19) + "      " + arrumarTamanhoDaString(String.valueOf(listaDeExames.get(0).getNomeConvenio()), 38));
                imprimir.lineFeed();
            } else{
                imprimir.print("    " + arrumarTamanhoDaString(nomeDoExame, 19));
                imprimir.lineFeed();
        ...
        imprimir.print("                  " + arrumarTamanhoDaString(listaDeExames.get(0).getDuracaoAtendimento(), 5) + "      " + arrumarTamanhoDaString(listaDeExames.get(0).getNomeMedicoSolicitante(), 38));
