...
public class A_INTERVALOSPORPERIODON {
    ...
    public static ResultSet getConsultar(Connection con) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao consultar Intervalos por Período. Procure o Administrador.",
    ...
    public static boolean getConsultarParaSalvarRegistro(Connection con, A_intervalosPorPeriodoN model) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                "Erro ao consultar se Intervalo por Período já existe. Procure o Administrador.", "ERRO",
    ...
    public static boolean getConsultarParaAtualizarRegistro(Connection con, A_intervalosPorPeriodoN model) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select * from a_intervalosporperiodon where nome=? and a_intervaloporperiodonid!=?");
            stmtQuery.setString(1, model.getNome());
    ...
    public static int getConsultarIdDeUmNomeCadastrado(Connection con, A_intervalosPorPeriodoN model) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select a_intervaloporperiodonid from a_intervalosporperiodon where nome=?");
            stmtQuery.setString(1, model.getNome());
            resultSet = stmtQuery.executeQuery();
            ...
            JOptionPane.showMessageDialog(null,
                "Erro ao consultar ID do intervalo por Período. Procure o Administrador.", "ERRO",
                javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
    ...
    public static ResultSet getConsultarDadosDeUmIntervaloPorHorario(Connection con, int intervaloPorPeriodoNId) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select * from a_intervalosporperiodon where a_intervaloporperiodonid=?");
            stmtQuery.setInt(1, intervaloPorPeriodoNId);
            resultSet = stmtQuery.executeQuery();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Erro ao consultar Intervalo por Período. Procure o Administrador.",
                "ERRO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return resultSet;
        }
    ...
    public static boolean setCadastrar(Connection con, A_intervalosPorPeriodoN model) {
        ...
        String sql =
            "insert into a_intervalosporperiodon (dat,usuarioid,nome,horarioinicial,horariofinal,diaInicial,diaFinal,descricao) values(?,?,?,?,?,?,?,?)";
        try {
            ...
            conseguiuConsulta = false;
            JOptionPane.showMessageDialog(null, "Erro ao cadastrar Intervalo por Período. Procure o Administrador.",
                "ERRO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return cadastro;
        }
    ...
    public static boolean setDeletar(Connection con, int intervaloPorPeriodoNId) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Intervalo por Período. Procure o Administrador.",
                "ERRO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return deleto;
        }
    ...
    public static boolean setAtualizar(Connection con, A_intervalosPorPeriodoN model) {
        boolean cadastro = false;
        String sql =
            "update a_intervalosporperiodoN set dat=?, usuarioid=?, nome=?, horarioinicial=?, horariofinal=?,  diainicial=?, diafinal=?, descricao=? where a_intervaloporperiodonid=?";
        try {
            PreparedStatement stmt = con.prepareStatement(sql);
            stmt.setDate(1, model.getDat());
            stmt.setInt(2, model.getUsuarioId());
            ...
            conseguiuConsulta = false;
            JOptionPane.showMessageDialog(null, "Erro ao atualizar Intervalo por Período. Procure o Administrador.",
                "ERRO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return cadastro;
        }
