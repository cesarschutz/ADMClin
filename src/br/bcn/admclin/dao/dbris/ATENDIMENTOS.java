...
public class ATENDIMENTOS {
    ...
    public static ResultSet getConsultarAtendimentos(Connection con, Date dia) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select p.nome as nomePaciente, m.nome as nomeMedico, m.crm as crmMedico, a.handle_at, a.data_atendimento, a.hora_atendimento, a.status1, a.status2, a.EXAME_ENTREGUE_AO_PACIENTE, a.LAUDO_ENTREGUE_AO_PACIENTE, a.paciente_pagou from atendimentos A "
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select P.nome as nomepac, p.handle_paciente as handle_paciente, p.peso as peso, p.cidade as cidade, p.endereco as endereco_paciente, p.altura as altura, p.nascimento as nascimento_paciente, "
                		...
                		+ "a.hora_exame_pronto, a.EXAME_ENTREGUE_AO_PACIENTE, a.LAUDO_ENTREGUE_AO_PACIENTE, a.FLAG_LAUDO, u.nm_usuario "
