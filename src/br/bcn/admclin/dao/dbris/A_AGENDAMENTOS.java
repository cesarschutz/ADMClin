...
public class A_AGENDAMENTOS {
    ...
    public static ResultSet getConsultarDadosDeUmAgendamento(Connection con, int handle_ap) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao verificar dados do Agendamento. Procure o Administrador.",
    ...
    public static ResultSet getConsultarAgendamentos(Connection con, int handle_agenda, Date dia) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select * from a_agendamentos where handle_agenda =? and dia=? order by hora");
            stmtQuery.setInt(1, handle_agenda);
            stmtQuery.setDate(2, dia);
            resultSet = stmtQuery.executeQuery();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Erro ao verificar os Agendamentos. Procure o Administrador.", "ERRO",
    ...
    public static boolean setCadastrar(Connection con, A_Agendamentos agendamento) {
        ...
        String sql =
            "insert into a_agendamentos (dia,nascimento,dat,"
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao registrar Agendamento. Procure o Administrador.", "ERRO",
                javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return cadastro;
        }
    ...
    public static boolean getConsultarAntesDeSalvar(Connection con, int handle_agenda, Date dia, int horario) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select * from a_agendamentos where handle_agenda =? and dia=? and hora=? and nomepaciente!=?");
            stmtQuery.setInt(1, handle_agenda);
            stmtQuery.setDate(2, dia);
    ...
    public static void setSomarHandleAP(Connection con) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao somar handle_ap. Procure o Administrador.", "ERRO",
                javax.swing.JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public static int getHandleAP(Connection con) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao buscar valor de handle_ap. Procure o Administrador.", "ERRO",
                javax.swing.JOptionPane.ERROR_MESSAGE);
            return 0;
        }
    }
    ...
    public static boolean setDeletar(Connection con, int handle_ap) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Agendamento. Procure o Administrador.", "ERRO",
                javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return deleto;
        }
