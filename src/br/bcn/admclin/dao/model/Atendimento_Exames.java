...
public class Atendimento_Exames {
    ...
    private int HANDLE_AT, HANDLE_EXAME, DURACAO, ATENDIMENTO_EXAME_ID, FLAG_CONCILIADO;
    ...
    private double VALOR_CORRETO_EXAME, VALOR_CORRETO_CONVENIO, VALOR_CORRETO_PACIENTE, VALOR_DESCONTO, VALOR_RECEBIDO_CONVENIO;
    private Date data, DATA_RECEBIDO_CONVENIO;
    ...
    public int getFLAG_CONCILIADO() {
        return FLAG_CONCILIADO;
    }

    public void setFLAG_CONCILIADO(int fLAG_CONCILIADO) {
        FLAG_CONCILIADO = fLAG_CONCILIADO;
    }

    public double getVALOR_RECEBIDO_CONVENIO() {
        return VALOR_RECEBIDO_CONVENIO;
    }

    public void setVALOR_RECEBIDO_CONVENIO(double vALOR_RECEBIDO_CONVENIO) {
        VALOR_RECEBIDO_CONVENIO = vALOR_RECEBIDO_CONVENIO;
    }

    public Date getDATA_RECEBIDO_CONVENIO() {
        return DATA_RECEBIDO_CONVENIO;
    }

    public void setDATA_RECEBIDO_CONVENIO(Date dATA_RECEBIDO_CONVENIO) {
        DATA_RECEBIDO_CONVENIO = dATA_RECEBIDO_CONVENIO;
    }    
}
