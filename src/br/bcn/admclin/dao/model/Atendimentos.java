...
public class Atendimentos {
    ...
    private int HANDLE_AT, HORA_ATENDIMENTO, DURACAO_ATENDIMENTO, HANDLE_PACIENTE, HANDLE_MEDICO_SOL, HANDLE_AGENDA, HANDLE_CONVENIO, USUARIOID, HORA_EXAME_PRONTO;
