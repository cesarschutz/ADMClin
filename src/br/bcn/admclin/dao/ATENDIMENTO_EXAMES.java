...
public class ATENDIMENTO_EXAMES {
    ...
    public static boolean setCadastrar(Connection con, Atendimento_Exames atendimento_exame) {
        ...
        String sql =
            "insert into atendimento_exames (handle_at, handle_exame, duracao,"
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao registrar Exame no Atendimento. Procure o Administrador.",
    ...
    public static boolean setDeletarTodosDeUmAtendimento(Connection con, int handle_at) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Exames. Procure o Administrador.", "ERRO",
    ...
    public static ResultSet getConsultarExamesDeUmAtendimento(Connection con, int handle_at) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select E.nome as nomeExame, a.handle_exame, A.duracao,  a.valor_exame, a.valor_paciente, a.valor_convenio, a.ch_convenio, a.filme_convenio, a.ch1_exame, a.ch2_exame, a.filme_exame, a.lista_materiais, a.lado, a.material, a.redutor, a.desconto_paciente, a.porcentagem_convenio, a.porcentagem_paciente, a.valor_correto_exame, a.valor_correto_convenio, a.valor_correto_paciente, a.valor_desconto,a.atendimento_exame_id from atendimento_exames A "
            ...
            JOptionPane.showMessageDialog(null, "Erro ao consultar Exames do Atendimento. Procure o Administrador.",
                "ERRO", javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
            return resultSet;
        }
