...
public class RESPONSAVEIS_TECNICOS {
    ...
    public static ResultSet getConsultar(Connection con){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao consultar Responsáveis Técnicos. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
    ...
    public static boolean getConsultarParaSalvarNovoRegistro(Connection con, Responsaveis_Tecnicos responsavelTecnico){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao consultar se Responsável Técnico existe. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
           return existe; 
        }  
    }
    ...
    public static boolean setCadastrar(Connection con, Responsaveis_Tecnicos responsavelTecnico){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao cadastrar Responsável Técnico. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return cadastro;
        }
    }
    ...
    public static boolean setUpdate(Connection con, Responsaveis_Tecnicos responsavelTecnico){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao atualizar Responsável Técnico. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return atualizo;
        }
    }
    ...
    public static boolean setDeletar(Connection con, Responsaveis_Tecnicos responsavelTecnico){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Responsável Técnico. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return deleto;
        }
    }
