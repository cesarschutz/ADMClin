...
public class ATENDIMENTOS {
    ...
    public static ResultSet getConsultarAtendimentosPorPeriodoEConvenio(Connection con, Date diaInicial, Date diaFinal,
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select distinct a.handle_at, a.matricula_convenio, a.data_atendimento, c.porcentconvenio, f.valor, e.VALOR_CORRETO_CONVENIO, e.atendimento_exame_id, e.lista_materiais, p.nome, m.crm, t.cod_exame from atendimento_exames e "
    ...
    public static ResultSet getConsultarAtendimentosPorPeriodoEGrupo(Connection con, Date diaInicial, Date diaFinal,
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select distinct a.handle_at, a.matricula_convenio, a.data_atendimento, c.porcentconvenio, c.handle_convenio, f.valor, e.VALOR_CORRETO_CONVENIO, e.atendimento_exame_id, e.lista_materiais, p.nome, m.crm, t.cod_exame from atendimento_exames e "
                    + "inner join atendimentos a on a.handle_at = e.handle_at "
                    + "inner join pacientes p on a.handle_paciente = p.handle_paciente "
                    + "inner join medicos m on a.handle_medico_sol = m.medicoid "
