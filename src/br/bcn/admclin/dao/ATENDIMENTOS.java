...
public class ATENDIMENTOS {
    ...
    public static ResultSet getConsultarAtendimentosAgenda(Connection con, int handle_agenda, Date dia){
        ResultSet resultSet = null;
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select p.nome, a.handle_at, a.hora_atendimento, a.duracao_atendimento from atendimentos A inner join pacientes p on a.handle_paciente = p.handle_paciente where handle_agenda =? and data_atendimento=? order by hora_atendimento");
            stmtQuery.setInt(1, handle_agenda);
            stmtQuery.setDate(2, dia);
            resultSet = stmtQuery.executeQuery();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Erro ao verificar os Atendimentos. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
    /**
     * Consulta Todos os atendimentos desta agenda existentes no Banco de Dados que sejam reservas (o atendente ainda esta cadastrando o atendimento, esta com a janela atendimento daquele horario aberta)
     * @param Connection
     * @return ResultSet
     */
    public static ResultSet getConsultarAtendimentosAgendaReservados(Connection con, int handle_agenda, Date dia){
        ResultSet resultSet = null;
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select * from atendimentos where handle_paciente=? and handle_agenda=? and data_atendimento=?");
            stmtQuery.setInt(1, 0);
            stmtQuery.setInt(2, handle_agenda);
            stmtQuery.setDate(3, dia);
            resultSet = stmtQuery.executeQuery();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Erro ao verificar os Atendimentos Reservados. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
    ...
    public static ResultSet getConsultarAtendimentos(Connection con, Date dia){
        ResultSet resultSet = null;
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select p.nome as nomePaciente, m.nome as nomeMedico, m.crm as crmMedico, a.handle_at, a.data_atendimento, a.hora_atendimento, a.status1, a.modalidade, a.status2, a.EXAME_ENTREGUE_AO_PACIENTE, a.LAUDO_ENTREGUE_AO_PACIENTE from atendimentos A "
    ...
    public static ResultSet getConsultarAtendimentosPorAgenda(Connection con, Date dia, int handle_agenda){
        ResultSet resultSet = null;
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select p.nome as nomePaciente, m.nome as nomeMedico, m.crm as crmMedico, a.handle_at, a.data_atendimento, a.hora_atendimento, a.status1, a.modalidade, a.status2, a.EXAME_ENTREGUE_AO_PACIENTE, a.LAUDO_ENTREGUE_AO_PACIENTE, a.valor_desconto, a.valor_atendimento from atendimentos A "
                    + "inner join medicos m on a.handle_medico_sol = m.medicoId "
                    + "inner join pacientes p on a.handle_paciente = p.handle_paciente "
    ...
    public static ResultSet getConsultarDadosDeUmAtendimento(Connection con, int handle_at){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao consultar Dados do Atendimento. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
    ...
    public static boolean setDeletar(Connection con, int handle_at){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao deletar Atendimento. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return deleto;
        }
    }
    ...
    public static boolean setUpdateFlagImprimiu(Connection con, int handle_at){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao marcar flag de Impressão. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return cadastro;
        }
    }
    ...
    public static boolean setUpdateStatus1(Connection con, int handle_at, String status){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao mudar Status do Atendimento. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return cadastro;
        }
    }
    ...
    /**
     * buscando o status 1 quando for imprimir!!
     * se tive passado de 1 é pq nao fez algo depois de imprimir ficha e entao retorna false
     * se for 1 retorna false tb pois ja esta o mesmo flag que iriamos marcar
     * se for nulo ou vazio retonr tru para ele marcar o flag como 1 que foi impresso a ficha (ou seja paciente esta em atendimento, ainda nao mudo para exame ou laduo pronto!!
     * @param Connection 
     * @return Boolean
     */
    public static boolean getMarcarStatus1(Connection con, int handle_at){
        ...
        try{
            ...
            while(rs.next()){
                ...
                try {
                    //se conseguir converter retorna false para que nao marque 
                    //pois ja esta algo no status, entao soh vai imprimir e marcar o flag_imprimiu
                    int status1Int = Integer.valueOf(status1);
                } catch (Exception e) {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao mudar Status do Atendimento. Procure o Administrador." + e,"ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
    ...
    public static boolean setEntregouExameAoPaciente(Connection con, int handle_at){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao marcar Exame Entregue ao Paciente. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return cadastro;
        }
    }
    ...
    public static boolean setLaudoExameAoPaciente(Connection con, int handle_at){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Erro ao marcar Laudo Entregue ao Paciente. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return cadastro;
        }
    }
    ...
    /**
     * se vier no parametro 1 - entregou somente o exame
     * se vier no parametro 2 - entregou somente o laudo
     * se vier no parametro 3 - entregou os dois
     * @param Connection 
     * @param PacienteMODEL
     * @return Boolean
     */
    public static boolean setEntregaDeExame(Connection con, int parametro, int handle_at){
        if(parametro == 1){
            boolean cadastro = false;
            String sql = "update atendimentos set EXAME_ENTREGUE_AO_PACIENTE='S', LAUDO_ENTREGUE_AO_PACIENTE='N' where handle_at="+handle_at;
            try{
                PreparedStatement stmt = con.prepareStatement(sql);
                stmt.executeUpdate();
                stmt.close();
                ...
                JOptionPane.showMessageDialog(null, "Erro ao marcar flag de Entrega ao Paciente. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
            }finally{
                return cadastro;
            }  
        }else if(parametro == 2){
            boolean cadastro = false;
            String sql = "update atendimentos set LAUDO_ENTREGUE_AO_PACIENTE='S', EXAME_ENTREGUE_AO_PACIENTE='N' where handle_at="+handle_at;
            try{
                PreparedStatement stmt = con.prepareStatement(sql);
                stmt.executeUpdate();
                stmt.close();
            ...
            boolean cadastro = false;
            String sql = "update atendimentos set LAUDO_ENTREGUE_AO_PACIENTE='S', EXAME_ENTREGUE_AO_PACIENTE='S'   where handle_at="+handle_at;
            try{
                PreparedStatement stmt = con.prepareStatement(sql);
                stmt.executeUpdate();
                stmt.close();
    ...
    public static ResultSet getConsultarModeloDeValidacaoMatriculaDoConvenio(Connection con, int handle_convenio){
        ResultSet resultSet = null;
        try{
        PreparedStatement stmtQuery = con.prepareStatement("select validacao_matricula from convenio where handle_convenio=?");
        stmtQuery.setInt(1, handle_convenio);
        resultSet = stmtQuery.executeQuery();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Erro ao consultar Modelo de Validação da Matrícula. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
    ...
    public static ResultSet getConsultarAgendaDeUmAtendimento(Connection con, int handle_at){
        ResultSet resultSet = null;
        try{
            PreparedStatement stmtQuery = con.prepareStatement("select a.handle_agenda, p.nome as nomepac from atendimentos as a " +
                "inner join agendas p on a.handle_agenda = p.handle_agenda " +
                "where a.handle_at=?");
            stmtQuery.setInt(1, handle_at);
            resultSet = stmtQuery.executeQuery();
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, "Erro ao consultar Agenda do Atendimento. Procure o Administrador.","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
            return resultSet;
        }
    }
