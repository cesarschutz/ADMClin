    ...
    public static ResultSet getConsultarAtendimentosPorNome(Connection con, String nome) {
        ...
        try {
            PreparedStatement stmtQuery =
                con.prepareStatement("select p.nome as nomePaciente, m.nome as nomeMedico, m.crm as crmMedico, a.handle_at, a.data_atendimento, a.hora_atendimento, a.status1, a.modalidade from atendimentos A "
