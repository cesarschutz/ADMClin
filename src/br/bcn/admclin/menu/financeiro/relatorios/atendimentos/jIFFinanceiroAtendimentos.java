 ...
 */
package br.bcn.admclin.menu.financeiro.relatorios.atendimentos;
...
public class jIFFinanceiroAtendimentos extends javax.swing.JInternalFrame {
        ...
        SwingWorker worker = new SwingWorker(){
            ...
            protected Object doInBackground() throws Exception {
                ...
                if (verificarDatas()) {
                   ...
                   relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificos relatorio = new relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificos(diaInicialSql, diaFinalSql);
        ...
        SwingWorker worker = new SwingWorker(){
            ...
            protected Object doInBackground() throws Exception {
                ...
                if (verificarDatas()) {
                   ...
                   relatorioUmConvenioTodasClassesAnaliticoValoresEspecificos relatorio = new relatorioUmConvenioTodasClassesAnaliticoValoresEspecificos(diaInicialSql, diaFinalSql, handle_convenio);
                   relatorio.gerarRelatorio();
                }else{
                    JOptionPane.showMessageDialog(null, "Verifique as datas e tente novamente.");
                }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Relatório Financeiro dos Atendimentos", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jCBConvenio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "", "Convênios", "Modalidades", "Classes de Exames", "Médicos" }));
        ...
        jCBValor.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Valores Totais", "Valores Específicos" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(jBGerarRelatorio, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 369, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jCBValor, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                    .addComponent(jLabel5)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                    .addComponent(jCBTipoDeRelatorio, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jCBRelatorioPor, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jCBConvenio, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jCBRelatorioPor, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(jCBTipoDeRelatorio, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
        ...
        if (jCBConvenio.getSelectedIndex() == 0) {
            ...
            if (jCBRelatorioPor.getSelectedIndex() == 0) {
                ...
                if (jCBTipoDeRelatorio.getSelectedIndex() == 0) {
                    ...
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                        JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por classe de exame - sintetico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                        JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por classe de exame - sintetico - valores especificos");
                    }
                } else if (jCBTipoDeRelatorio.getSelectedIndex() == 1){
                    //relatorio analitico
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                        JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por classe de exame - analitico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                        //todos os convenios - relatorio por classe de exame - analitico - valores especidicos
                ...
                if (jCBTipoDeRelatorio.getSelectedIndex() == 0) {
                    ...
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                        JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por medicos - sintetico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                         JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por medicos - sintetico - valores especificos");
                    }
                } else if (jCBTipoDeRelatorio.getSelectedIndex() == 1){
                    //relatorio analitico
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                         JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por medicos - analitico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                         JOptionPane.showMessageDialog(null, "todos os convenios - relatorio por medicos - analitico - valores especificos");
                    }
                }
            ...
            if (jCBRelatorioPor.getSelectedIndex() == 0) {
                ...
                if (jCBTipoDeRelatorio.getSelectedIndex() == 0) {
                    ...
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                        JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por classe de exame - sintetico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                        JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por classe de exame - sintetico - valores especificos");
                    }
                } else if (jCBTipoDeRelatorio.getSelectedIndex() == 1){
                    //relatorio analitico
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                        JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por classe de exame - analitico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                ...
                if (jCBTipoDeRelatorio.getSelectedIndex() == 0) {
                    ...
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                        JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por medicos - sintetico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                         JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por medicos - sintetico - valores especificos");
                    }
                } else if (jCBTipoDeRelatorio.getSelectedIndex() == 1){
                    //relatorio analitico
                    if (jCBValor.getSelectedIndex() == 0) {
                        //valores totais
                         JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por medicos - analitico - valores totais");
                    }else if (jCBValor.getSelectedIndex() == 1){
                        //valores especificos
                         JOptionPane.showMessageDialog(null, "convenio especifico - relatorio por medicos - analitico - valores especificos");
                    }
                }
