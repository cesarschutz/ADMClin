...
public class JIFCResponsaveisTecnicos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTFRegistroConselho = new JFormattedTextField(new br.bcn.admclin.ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("######"));
        ...
        jTFRegistroAns = new JFormattedTextField(new br.bcn.admclin.ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("######"));
