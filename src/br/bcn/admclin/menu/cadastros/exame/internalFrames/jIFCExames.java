...
public class jIFCExames extends javax.swing.JInternalFrame {
    ...
    public void iniciarClasse(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher as Classes de Exames. Procure o administrador." + e,"ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
    ...
    public void atualizarTabela(){
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos os Exames", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    public boolean verificarSeLaudoFoiSelecionado(){
        boolean selecionado = false;
            ...
            jTFMensagemParaUsuario.setText("Informe s"
                    + "e Exame Formula Laudo");
            }
        return selecionado;
    }
    ...
    public void botaoSalvarRegistro(){
        ...
        horasUteisOk = MetodosUteis.verificarSeCampoComMascaraFoiPrenchido(jTFHorasUteis, jTFMensagemParaUsuario, "   ");
    ...
    private void initComponents() {
        ...
        jTFHorasUteis = new JFormattedTextField(new br.bcn.admclin.ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("###"));
        jLabel10 = new javax.swing.JLabel();
        jRBSim = new javax.swing.JRadioButton();
        jRBNao = new javax.swing.JRadioButton();
        jTFDuracao = new JFormattedTextField(new br.bcn.admclin.ClasseAuxiliares.MetodosUteis().mascaraParaJFormattedTextField("####"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Exames", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informações do Exame", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jCBModalidade.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "CR", "CT", "DO", "DR", "DX", "MG", "MR", "NM", "OD", "OT", "RF", "US", "TR" }));
        jCBModalidade.setEnabled(false);
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTFNome, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 395, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jTFHorasUteis, javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel7)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jCBDescricaoClasse, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFHorasUteis, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jRBSim)
                    .addComponent(jRBNao))
    ...
    private void jTFPesquisaNomeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFPesquisaNomeKeyReleased
        ...
        while (i < listaExames.size()) {
            if (listaExames.get(i).getNOME().startsWith(jTFPesquisaNome.getText().toUpperCase())) {
                DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
                modelo.addRow(new String[]{Integer.toString(listaExames.get(i).getHANDLE_EXAME()), listaExames.get(i).getNOME()});
            }
            i++;
        }
        ...
        if ("".equals(jTFPesquisaNome.getText())) {
            ...
            jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Exame(s) encontrado(s) pela Pesquisa", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        int indexDoArray=0;
            ...
            while(cont<listaExames.size()){
                ...
                if(HANDLE_EXAME == HANDLE_EXAMESObjetos){
                    ...
                    if (duracao.length() == 1) duracao = "000" + duracao; 
                    if (duracao.length() == 2) duracao = "00" + duracao; 
                    if (duracao.length() == 3) duracao = "0" + duracao; 
                     ...
                     jCBDescricaoClasse.setSelectedIndex(indexDoArray);System.out.println(listaExames.get(cont).getModalidade());
