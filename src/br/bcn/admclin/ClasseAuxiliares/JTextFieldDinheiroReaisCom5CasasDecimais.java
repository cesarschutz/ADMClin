 ...
 */
public class JTextFieldDinheiroReaisCom5CasasDecimais extends JTextField {
    ...
    public JTextFieldDinheiroReaisCom5CasasDecimais(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,#####0" : "#,#####0.") + makeZeros(casasDecimais)));
    }
 
    public JTextFieldDinheiroReaisCom5CasasDecimais() {
        this(MONETARY_FORMAT);
    }
 
    public JTextFieldDinheiroReaisCom5CasasDecimais(NumberFormat format) {// define o formato do
        // número
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(JTextFieldDinheiroReaisCom5CasasDecimais.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
