...
public class StringEncrypter {
    ...
    public static String encryptor(String key,String secret) {
    ...
    public static String decryptor(String key,String secret) {
    ...
    public static void main(String[] args) {
        testUsingSecretKey();
        testUsingPassPhrase();
        String retorno = encriptor("ThEoDoRo","12345");
        System.out.println("    Original String  : " + "12345");
        System.out.println("    Encrypted String : " + retorno);
        String retorno2 = decriptor("ThEoDoRo",retorno);
        System.out.println("    Original String  : " + retorno);
        System.out.println("    Decrypted String : " + retorno2);
    }
     * 
     */
