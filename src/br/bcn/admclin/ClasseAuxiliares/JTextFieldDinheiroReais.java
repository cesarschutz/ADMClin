 ...
 */
public class JTextFieldDinheiroReais extends JTextField {
    ...
    public JTextFieldDinheiroReais(int casasDecimais) {
        this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
    }
 
    public JTextFieldDinheiroReais() {
        this(MONETARY_FORMAT);
    }
 
    public JTextFieldDinheiroReais(NumberFormat format) {// define o formato do
        // número
        ...
        setDocument(new PlainDocument() {
            ...
            public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
                String text = new StringBuilder(JTextFieldDinheiroReais.this.getText().replaceAll("[^0-9]", "")).append(str.replaceAll("[^0-9]", "")).toString();
