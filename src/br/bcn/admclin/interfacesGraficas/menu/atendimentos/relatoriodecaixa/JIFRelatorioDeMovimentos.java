 ...
 * @author Cesar Schutz
 */
public class JIFRelatorioDeMovimentos extends javax.swing.JInternalFrame {
     ...
     */
    public JIFRelatorioDeMovimentos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Relat\u00F3rio de Movimento", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(0, 0, 0)));
        	...
        	jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING)
        				...
        				.addComponent(jBGerarRelatorio, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 369, GroupLayout.PREFERRED_SIZE)))
        );
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addComponent(jPanel1, GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE)
    ...
    private void jBGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jBGerarRelatorioActionPerformed
    	if(verificarDatas()){
    		...
    		relatorioDeMovimentos rel = new relatorioDeMovimentos(diaInicialSql, diaFinalSql);
    		rel.gerarRelatorio();
    	}
