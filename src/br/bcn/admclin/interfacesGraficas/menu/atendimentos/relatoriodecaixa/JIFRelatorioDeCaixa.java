 ...
 * @author Cesar Schutz
 */
public class JIFRelatorioDeCaixa extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new TitledBorder(null, "Relat\u00F3rio de Caixa", TitledBorder.CENTER, TitledBorder.TOP, null, null));
    ...
    private void jBGerarRelatorioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jBGerarRelatorioActionPerformed
    	if(verificarDatas()){
    		...
    		relatorioDeCaixa rel = new relatorioDeCaixa(diaInicialSql, diaFinalSql);
    		rel.gerarRelatorio();
    	}
