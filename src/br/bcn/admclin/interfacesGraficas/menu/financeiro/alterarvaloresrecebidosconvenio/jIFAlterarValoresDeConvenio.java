 ...
 * @author Cesar Schutz
 */
public class jIFAlterarValoresDeConvenio extends javax.swing.JInternalFrame {
     ...
     */
    public jIFAlterarValoresDeConvenio() {
        initComponents();
    ...
    private void botaoGerarFaturaConvenio() {
        ...
        if (verificarDatas()) {
            ...
            try {
                janelaPrincipal.internalFrameListaAlterarValoresDeConvenio = new jIFListaAlterarValoresDeConvenio("convenio", diaInicialSql, diaFinalSql, 
                		listaHandleConvenio.get(jCBConvenios.getSelectedIndex()));

                janelaPrincipal.jDesktopPane1.add(janelaPrincipal.internalFrameListaAlterarValoresDeConvenio);
                janelaPrincipal.internalFrameListaAlterarValoresDeConvenio.setVisible(true);

                int lDesk = janelaPrincipal.jDesktopPane1.getWidth();
                int aDesk = janelaPrincipal.jDesktopPane1.getHeight();
                int lIFrame = janelaPrincipal.internalFrameListaAlterarValoresDeConvenio.getWidth();
                int aIFrame = janelaPrincipal.internalFrameListaAlterarValoresDeConvenio.getHeight();

                janelaPrincipal.internalFrameListaAlterarValoresDeConvenio.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2
                    - aIFrame / 2);
    ...
    public void botaoGerarFaturaGrupo() {
        ...
        if (verificarDatas()) {
            ...
            try {
                janelaPrincipal.internalFrameListaAlterarValoresDeConvenio = new jIFListaAlterarValoresDeConvenio("grupo", diaInicialSql, diaFinalSql,
