...
public class relatorioTodosConveniosTodasClassesAnaliticoValoresEspecificos {
    ...
    public void criandoFatura() throws FileNotFoundException, DocumentException {
        ...
        PdfWriter.getInstance(document, new FileOutputStream(caminho
            + "relatórioTodosConvêniosTodasClassesDeExamesAnalíticoValoresEspecíficos.pdf"));
        document.open();
    ...
    private Double calcularValorDeCh(String ch_convenioString, String ch1_exameString, String ch2_exameString) {
        ...
        // isso acontecera no caso de o valor do exame ter sido alterado pela atendente (ae os ch ficam vazios, dara o
        // erro e sei que é 0)
        try {
