...
import br.bcn.admclin.dao.dbris.A_INTERVALOSPORHORARION;
...
public class JIFIntervaloPorHorario extends javax.swing.JInternalFrame {
    ...
    public void botaoCancelar() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar =
            new JIFIntervaloPorHorarioVisualizar();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar.setLocation(lDesk / 2 - lIFrame / 2,
            aDesk / 2 - aIFrame / 2);
    }
