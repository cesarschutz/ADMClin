...
public class JIFIntervaloPorPeriodoVisualizar extends javax.swing.JInternalFrame {
    ...
    public void botaoNovo() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo = new JIFIntervaloPorPeriodo("novo", 0);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2
            - aIFrame / 2);
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo =
