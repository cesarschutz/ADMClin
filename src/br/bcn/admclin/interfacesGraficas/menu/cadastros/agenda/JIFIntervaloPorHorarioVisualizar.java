...
public class JIFIntervaloPorHorarioVisualizar extends javax.swing.JInternalFrame {
    ...
    public void PreenchendoTabela() {
        ...
        try {
            while (resultSet.next()) {
                ...
                modelo.addRow(new String[] { String.valueOf(resultSet.getString("A_INTERVALOPORHORARIONID")),
    ...
    public void botaoNovo() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorarioVisualizar = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario = new JIFIntervaloPorHorario("novo", 0);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2
            - aIFrame / 2);
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos os Intervalos por Horário",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        jTable1.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

        }, new String[] { "intervaloPorHorarioId", "Nome" }) {
            private static final long serialVersionUID = 1L;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario =
            new JIFIntervaloPorHorario("editar", intervaloPorHorarioId);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario.setVisible(true);
        int lDesk = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1.getWidth();
        ...
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorHorario.setLocation(lDesk / 2 - lIFrame / 2, aDesk / 2
            - aIFrame / 2); // TODO add your handling code here:
