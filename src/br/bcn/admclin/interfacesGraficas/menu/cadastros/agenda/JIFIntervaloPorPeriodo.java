...
import br.bcn.admclin.dao.dbris.A_INTERVALOSPORPERIODON;
...
public class JIFIntervaloPorPeriodo extends javax.swing.JInternalFrame {
    ...
    public JIFIntervaloPorPeriodo(String novoOuEditar, int intervaloPorPeriodoId) {
        ...
        if ("novo".equals(novoOuEditar)) {
            ...
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
                "Cadastro de novo Intervalo por Período", javax.swing.border.TitledBorder.CENTER,
                javax.swing.border.TitledBorder.DEFAULT_POSITION));
        }
        if ("editar".equals(novoOuEditar)) {
            jBSalvar.setVisible(false);
            this.intervaloPorPeriodoId = intervaloPorPeriodoId;
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editar Intervalo por Período",
    ...
    public void preenchendoDadosDoIntervalo() {
        ...
        ResultSet resultSet =
            A_INTERVALOSPORPERIODON.getConsultarDadosDeUmIntervaloPorHorario(con, intervaloPorPeriodoId);
        try {
            ...
            JOptionPane.showMessageDialog(null,
                "Não foi possivel preencher dados do Intervalo por Período. Procure o administrador", "ERRO",
    ...
    public void botaoCancelar() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodo = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar =
            new JIFIntervaloPorPeriodoVisualizar();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameIntervaloPorPeriodoVisualizar.setLocation(lDesk / 2 - lIFrame / 2,
            aDesk / 2 - aIFrame / 2);
    }
            ...
            if (jTable1.getRowCount() > 0) {
                ...
                if (A_INTERVALOSPORPERIODON.conseguiuConsulta) {
                    if (existe) {
                        ...
                        intervaloPorPeriodoNModel.setHorarioInicial(MetodosUteis
                            .transformarHorarioEmMinutos(jTFHorarioInicial.getText()));
                        intervaloPorPeriodoNModel.setHorarioFinal(MetodosUteis
                            .transformarHorarioEmMinutos(jTFHorarioFinal.getText()));
                        ...
                        try {
                            java.sql.Date diaDoIntervaloCorrreto2 =
                                new java.sql.Date(format2.parse(diaDoIntervalo2).getTime());
                        ...
                        if (cadastro) {
                            ...
                            intervaloPorPeriodoNMODEL.setNome(jTFNome.getText().toUpperCase());
                            int idIntervalo =
                                A_INTERVALOSPORPERIODON
                                    .getConsultarIdDeUmNomeCadastrado(con, intervaloPorPeriodoNMODEL);
    ...
    public void botaoAtualizar() {
        if (verificandoSeTudoFoiPreenchido()) {
            if (jTable1.getRowCount() > 0) {
                ...
                boolean existe =
                    A_INTERVALOSPORPERIODON.getConsultarParaAtualizarRegistro(con, intervaloPorPeriodoNModel);
                Conexao.fechaConexao(con);
                if (A_INTERVALOSPORPERIODON.conseguiuConsulta) {
                    if (existe) {
                        JOptionPane.showMessageDialog(null, "Intervalo por Período já existe", "ATENÇÃO",
                            ...
                            jPanel2Layout
                                ...
                                .addGroup(
                                    jPanel2Layout
                                        ...
                                        .addGap(43, 43, 43)
                                        .addComponent(jTFNome, javax.swing.GroupLayout.DEFAULT_SIZE, 314,
                                            Short.MAX_VALUE))
                                .addGroup(
                                    jPanel2Layout
                                        .createSequentialGroup()
                                            ...
                                            jPanel2Layout
                                                ...
                                                .addGroup(
                                                    jPanel2Layout.createSequentialGroup().addComponent(jLabel1)
                                                        .addGap(5, 5, 5).addComponent(jTFHorarioInicial))
                                                .addGroup(
                                                    jPanel2Layout
                                                        .createSequentialGroup()
