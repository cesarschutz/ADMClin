...
public class jIFCAgendas extends javax.swing.JInternalFrame {
    ...
    public boolean verificarSeHorariosNaTabelaEstaoPreenchidosCorretamente(int coluna) {
        ...
        try {
            ...
            if ((horarioInicial == null || "  :  ".equals(horarioInicial) || "".equals(horarioInicial))
                && (horarioFinal == null || "  :  ".equals(horarioFinal) || "".equals(horarioFinal))
                && (duracao == null || "  :  ".equals(duracao) || "".equals(duracao))) {
                return true;
            } else {
                // if se algum deles estiver sem horario (nao preenchido) volta false
                if ((horarioInicial == null || "  :  ".equals(horarioInicial))
                    || (horarioFinal == null || "  :  ".equals(horarioFinal))
                    || (duracao == null || "  :  ".equals(duracao))) {
                    ...
                    if (MetodosUteis.verificarSeHoraEstaCorreta(horarioInicial)
                        && MetodosUteis.verificarSeHoraEstaCorreta(horarioFinal)
                        && MetodosUteis.verificarSeHoraEstaCorreta(duracao)) {
                        // se horario inicial eh maior ou gual ao horario final
                        if (MetodosUteis.transformarHorarioEmMinutos(horarioInicial) >= MetodosUteis
                            .transformarHorarioEmMinutos(horarioFinal)) {
                            jTFMensagemParaUsuario.setForeground(new java.awt.Color(255, 0, 0));
                            jTFMensagemParaUsuario.setText("Turno " + coluna + " incorreto");
                            return false;
                            // se duracao menor que 1 ou (horariofinal - horarioinicial) menor que duração volta falso
                        } else if ((MetodosUteis.transformarHorarioEmMinutos(duracao) < 1)
                            || (((MetodosUteis.transformarHorarioEmMinutos(horarioFinal) - MetodosUteis
                                .transformarHorarioEmMinutos(horarioInicial)) < MetodosUteis
                                .transformarHorarioEmMinutos(duracao)))) {
                            jTFMensagemParaUsuario.setForeground(new java.awt.Color(255, 0, 0));
                            jTFMensagemParaUsuario.setText("Turno " + coluna + " incorreto");
                            return false;
                            // se resto de horariofinal - horario inicial dividio por duracao sobrar algo q nao seja 0
                            // volta false
                        } else if ((MetodosUteis.transformarHorarioEmMinutos(horarioFinal) - MetodosUteis
                            .transformarHorarioEmMinutos(horarioInicial))
                            % MetodosUteis.transformarHorarioEmMinutos(duracao) != 0) {
                            jTFMensagemParaUsuario.setForeground(new java.awt.Color(255, 0, 0));
                            jTFMensagemParaUsuario.setText("Turno " + coluna + " incorreto");
                            return false;
                            // se coluna nao for a primeira e se horario inicial for menor que horario final do ultimo
                            // turno volta false
                        } else if (coluna != 1
                            && MetodosUteis.transformarHorarioEmMinutos(horarioInicial) < MetodosUteis
                                .transformarHorarioEmMinutos((String) jTable1.getValueAt(1, coluna - 1))) {
                            jTFMensagemParaUsuario.setForeground(new java.awt.Color(255, 0, 0));
    ...
    public boolean verificandoSeTudoFoiPreenchido() {
        ...
        if (!jCBcr.isSelected() && !jCBct.isSelected() && !jCBdr.isSelected() && !jCBdx.isSelected()
            && !jCBmg.isSelected() && !jCBmr.isSelected() && !jCBnm.isSelected() && !jCBot.isSelected()
            && !jCBrf.isSelected() && !jCBdo.isSelected() && !jCBus.isSelected() && !jCBod.isSelected()
            && !jCBtr.isSelected()) {
            modalidadeSelecionada = false;
            jTFMensagemParaUsuario.setForeground(new java.awt.Color(255, 0, 0));
            jTFMensagemParaUsuario.setText("Selecione pelo menos uma Modalidade");
        } else if (jCBcr.isSelected() || jCBct.isSelected() || jCBdr.isSelected() || jCBdx.isSelected()
            || jCBmg.isSelected() || jCBmr.isSelected() || jCBnm.isSelected() || jCBot.isSelected()
            || jCBrf.isSelected() || jCBdo.isSelected() || jCBus.isSelected() || jCBod.isSelected()
            || jCBtr.isSelected()) {
    ...
    public void botaoSalvar() {
        if (verificandoSeTudoFoiPreenchido() && verificarSeHorariosNaTabelaEstaoPreenchidosCorretamente(1)
            && verificarSeHorariosNaTabelaEstaoPreenchidosCorretamente(2)
            && verificarSeHorariosNaTabelaEstaoPreenchidosCorretamente(3)
            && verificarSeHorariosNaTabelaEstaoPreenchidosCorretamente(4)) {
            con = Conexao.fazConexao();
            ...
            if (AGENDAS.conseguiuConsulta) {
                if (existe) {
                    JOptionPane.showMessageDialog(null, "Agenda já existe", "ATENÇÃO",
                    ...
                    if ("  :  ".equals((String) jTable1.getValueAt(0, 1))
                        || ((String) jTable1.getValueAt(0, 1)) == null || "".equals((String) jTable1.getValueAt(0, 1))) {
                        agendaModelo.setHorarioInicialTurno1(0);
                    } else {
                        agendaModelo.setHorarioInicialTurno1(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(0, 1)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(1, 1))
                        || ((String) jTable1.getValueAt(1, 1)) == null || "".equals((String) jTable1.getValueAt(1, 1))) {
                        agendaModelo.setHorarioFinalTurno1(0);
                    } else {
                        agendaModelo.setHorarioFinalTurno1(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(1, 1)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(2, 1))
                        || ((String) jTable1.getValueAt(2, 1)) == null || "".equals((String) jTable1.getValueAt(2, 1))) {
                        agendaModelo.setDuracaoTurno1(0);
                    } else {
                        agendaModelo.setDuracaoTurno1(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(2, 1)));
                    }

                    // setando horario inicial, horario final e duração do turno 2
                    if ("  :  ".equals((String) jTable1.getValueAt(0, 2))
                        || ((String) jTable1.getValueAt(0, 2)) == null || "".equals((String) jTable1.getValueAt(0, 2))) {
                        agendaModelo.setHorarioInicialTurno2(0);
                    } else {
                        agendaModelo.setHorarioInicialTurno2(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(0, 2)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(1, 2))
                        || ((String) jTable1.getValueAt(1, 2)) == null || "".equals((String) jTable1.getValueAt(1, 2))) {
                        agendaModelo.setHorarioFinalTurno2(0);
                    } else {
                        agendaModelo.setHorarioFinalTurno2(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(1, 2)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(2, 2))
                        || ((String) jTable1.getValueAt(2, 2)) == null || "".equals((String) jTable1.getValueAt(2, 2))) {
                        agendaModelo.setDuracaoTurno2(0);
                    } else {
                        agendaModelo.setDuracaoTurno2(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(2, 2)));
                    }

                    // setando horario inicial, horario final e duração do turno 3
                    if ("  :  ".equals((String) jTable1.getValueAt(0, 3))
                        || ((String) jTable1.getValueAt(0, 3)) == null || "".equals((String) jTable1.getValueAt(0, 3))) {
                        agendaModelo.setHorarioInicialTurno3(0);
                    } else {
                        agendaModelo.setHorarioInicialTurno3(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(0, 3)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(1, 3))
                        || ((String) jTable1.getValueAt(1, 3)) == null || "".equals((String) jTable1.getValueAt(1, 3))) {
                        agendaModelo.setHorarioFinalTurno3(0);
                    } else {
                        agendaModelo.setHorarioFinalTurno3(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(1, 3)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(2, 3))
                        || ((String) jTable1.getValueAt(2, 3)) == null || "".equals((String) jTable1.getValueAt(2, 3))) {
                        agendaModelo.setDuracaoTurno3(0);
                    } else {
                        agendaModelo.setDuracaoTurno3(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(2, 3)));
                    }

                    // setando horario inicial, horario final e duração do turno 4
                    if ("  :  ".equals((String) jTable1.getValueAt(0, 4))
                        || ((String) jTable1.getValueAt(0, 4)) == null || "".equals((String) jTable1.getValueAt(0, 4))) {
                        agendaModelo.setHorarioInicialTurno4(0);
                    } else {
                        agendaModelo.setHorarioInicialTurno4(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(0, 4)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(1, 4))
                        || ((String) jTable1.getValueAt(1, 4)) == null || "".equals((String) jTable1.getValueAt(1, 4))) {
                        agendaModelo.setHorarioFinalTurno4(0);
                    } else {
                        agendaModelo.setHorarioFinalTurno4(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(1, 4)));
                    }

                    if ("  :  ".equals((String) jTable1.getValueAt(2, 4))
                        || ((String) jTable1.getValueAt(2, 4)) == null || "".equals((String) jTable1.getValueAt(2, 4))) {
                        agendaModelo.setDuracaoTurno4(0);
                    } else {
                        agendaModelo.setDuracaoTurno4(MetodosUteis.transformarHorarioEmMinutos((String) jTable1
                            .getValueAt(2, 4)));
                    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Agendas",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Informações da Agenda",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
            { "Horário Inicial", null, null, null, null }, { "Horário Final", null, null, null, null },
            { "Duração", null, "", null, null } }, new String[] { "", "Turno 1", "Turno 2", "Turno 3", "Turno 4" }) {
            private static final long serialVersionUID = 1L;
    ...
    public void preenchendoOsDadosDaAgendaQuandoForEditar() {
        ...
        try {
            while (resultSet.next()) {
                ...
                String horarioInicialTurno1 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horarioinicialturno1"));
                jTable1.setValueAt(horarioInicialTurno1, 0, 1);

                String horarioFinalTurno1 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horariofinalturno1"));
                ...
                String horarioInicialTurno2 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horarioinicialturno2"));
                jTable1.setValueAt(horarioInicialTurno2, 0, 2);

                String horarioFinalTurno2 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horariofinalturno2"));
                ...
                String horarioInicialTurno3 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horarioinicialturno3"));
                jTable1.setValueAt(horarioInicialTurno3, 0, 3);

                String horarioFinalTurno3 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horariofinalturno3"));
                ...
                String horarioInicialTurno4 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horarioinicialturno4"));
                jTable1.setValueAt(horarioInicialTurno4, 0, 4);

                String horarioFinalTurno4 =
                    MetodosUteis.transformarMinutosEmHorario(resultSet.getInt("horariofinalturno4"));
            ...
            JOptionPane.showMessageDialog(null, "Não foi possivel preencher dados da Agenda. Procure o administrador",
        ...
        if (jCBcr.isSelected() && jCBct.isSelected() && jCBdr.isSelected() && jCBdx.isSelected() && jCBmg.isSelected()
            && jCBmr.isSelected() && jCBnm.isSelected() && jCBot.isSelected() && jCBrf.isSelected()
            && jCBdo.isSelected() && jCBus.isSelected() && jCBod.isSelected() && jCBtr.isSelected()) {
