...
import br.bcn.admclin.dao.dbris.RESPONSAVEIS_TECNICOS;
...
public class JIFCResponsaveisTecnicos extends javax.swing.JInternalFrame {
    ...
    public void iniciarClasse() {
        ...
        if ("novo".equals(novoOuEditar)) {
            ...
            jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
                "Cadastro de novo Responsável Técnico", javax.swing.border.TitledBorder.CENTER,
                javax.swing.border.TitledBorder.DEFAULT_POSITION));
        } else {
            jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editar Responsável Técnico",
            ...
            while (cont < JIFCResponsaveisTecnicosVisualizar.listaResponsaveisTecnicos.size()) {
                ...
                if (rtId == codObjetos) {
                    ...
                    jTFConselho.setText(JIFCResponsaveisTecnicosVisualizar.listaResponsaveisTecnicos.get(cont)
                        .getConselho());
                    jTFRegistroConselho.setText(JIFCResponsaveisTecnicosVisualizar.listaResponsaveisTecnicos.get(cont)
                        .getRegistroConselho());
                    jTFCpf.setText(JIFCResponsaveisTecnicosVisualizar.listaResponsaveisTecnicos.get(cont).getCpf());
                    jCBUf.setSelectedItem(JIFCResponsaveisTecnicosVisualizar.listaResponsaveisTecnicos.get(cont)
                        .getUf());
                    jTFRegistroAns.setText(JIFCResponsaveisTecnicosVisualizar.listaResponsaveisTecnicos.get(cont)
                        .getRegistroAns());
                }
                cont++;
            }
    ...
    public void botaoCancelar() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar =
            new JIFCResponsaveisTecnicosVisualizar();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar.setLocation(
    ...
    public void botaoSalvarRegistro() {
        ...
        conselhoPreenchido =
            MetodosUteis.VerificarSeTextFieldContemMinimoDeCarcteres(jTFConselho, 2, jTFMensagemParaUsuario);
        regConselhoPreenchido =
            MetodosUteis.verificarSeCampoComMascaraFoiPrenchido(jTFRegistroConselho, jTFMensagemParaUsuario, "      ");
        cpfPreenchido =
            MetodosUteis.verificarSeCampoComMascaraFoiPrenchido(jTFCpf, jTFMensagemParaUsuario, "   .   .   -  ");
        ufPreenchido = MetodosUteis.VerificarSeComboBoxFoiSelecionado(jCBUf, jTFMensagemParaUsuario);
        regAnsPreenchido =
            MetodosUteis.verificarSeCampoComMascaraFoiPrenchido(jTFRegistroAns, jTFMensagemParaUsuario, "      ");

        if (nomePreenchido && conselhoPreenchido && regConselhoPreenchido && cpfPreenchido && ufPreenchido
            && regAnsPreenchido) {
    ...
    public void botaoApagarRegistro() {
        int resposta =
            JOptionPane.showConfirmDialog(null, "Deseja realmente deletar esse Responsável Técnico?", "ATENÇÃO", 0);
    ...
    private void initComponents() {
        ...
        jTFRegistroConselho = new JFormattedTextField(MetodosUteis.mascaraParaJFormattedTextField("######"));
        jLabel6 = new javax.swing.JLabel();
        jTFCpf = new JFormattedTextField(MetodosUteis.mascaraParaJFormattedTextField("###.###.###-##"));
        jLabel7 = new javax.swing.JLabel();
        jLabel8 = new javax.swing.JLabel();
        jTFRegistroAns = new JFormattedTextField(MetodosUteis.mascaraParaJFormattedTextField("######"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Responsável Técnico",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
                                ...
                                jPanel1Layout
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            ...
                                            .addComponent(jTFConselho, javax.swing.GroupLayout.DEFAULT_SIZE, 235,
                                                Short.MAX_VALUE))
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            ...
                                            .addComponent(jTFRegistroConselho, javax.swing.GroupLayout.PREFERRED_SIZE,
                                ...
                                jPanel1Layout
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            ...
                                            .addComponent(jTFCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 215,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addGroup(
                                        jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jLabel7).addComponent(jCBUf, 0, 152, Short.MAX_VALUE))))
                    .addContainerGap()));
                ...
                jPanel1Layout
                    ...
                    .addGroup(
                        jPanel1Layout
                            ...
                            .addComponent(jTFRegistroConselho, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTFConselho, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel8)
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jTFRegistroAns, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
