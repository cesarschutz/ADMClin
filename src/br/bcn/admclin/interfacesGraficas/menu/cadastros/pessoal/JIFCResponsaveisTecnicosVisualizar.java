...
public class JIFCResponsaveisTecnicosVisualizar extends javax.swing.JInternalFrame {
    ...
    public void atualizarTabela() {
        ...
        try {
            while (resultSet.next()) {
                ...
                modelo.addRow(new String[] { Integer.toString(resultSet.getInt("rtid")), resultSet.getString("nome"),
                    resultSet.getString("conselho") });
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos os Responsáveis Técnicos",
    ...
    public void botaoNovo() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos = new JIFCResponsaveisTecnicos("novo", 0);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos.setLocation(lDesk / 2 - lIFrame / 2, aDesk
            / 2 - aIFrame / 2);
    }
    ...
    private void initComponents() {
        ...
        }, new String[] { "RT ID", "Nome", "Conselho" }) {
            private static final long serialVersionUID = 1L;
    ...
    private void jTFPesquisaNomeFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_jTFPesquisaNomeFocusLost
        ...
        if ("".equals(verificar)) {
            ...
            while (i < listaResponsaveisTecnicos.size()) {
                DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
                modelo.addRow(new String[] { Integer.toString(listaResponsaveisTecnicos.get(i).getRtId()),
                    listaResponsaveisTecnicos.get(i).getNome(), listaResponsaveisTecnicos.get(i).getConselho() });
                i++;
            }
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos os Responsáveis Técnicos",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void jTFPesquisaNomeKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTFPesquisaNomeKeyReleased
        ...
        if ("".equals(jTFPesquisaNome.getText())) {
            ...
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
                "Responsáveis Técnicos(s) encontrado(s) pela Pesquisa", javax.swing.border.TitledBorder.CENTER,
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos =
            new JIFCResponsaveisTecnicos("editar", responsavelTecnicoId);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicos.setVisible(true);
        int lDesk = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1.getWidth();
        ...
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameResponsaveisTecnicosVisualizar = null; // TODO add your handling
                                                                                            // code here:
