...
public class JIFCEspecialidadesMedicasVisualizar extends javax.swing.JInternalFrame {
    ...
    /**
     * Atualiza a tabela e a listaEspecilidadesMedicas de acordo com o banco de dados.
     */
    public void atualizarTabela() {
        ...
        try {
            while (resultSet.next()) {
                ...
                modelo.addRow(new String[] { Integer.toString(resultSet.getInt("emid")),
                ...
                especilalidadeMedicaModelo.setDat(resultSet.getDate("dat"));
                listaEspecialidadesMedicas.add(especilalidadeMedicaModelo);
            }
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todas as Especialidades Médicas",
    ...
    public void botaoNovo() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicasVisualizar = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas = new JIFCEspecialidadesMedicas("novo", 0);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas.setLocation(lDesk / 2 - lIFrame / 2, aDesk
            / 2 - aIFrame / 2);
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todos os Pacientes",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        }, new String[] { "Especialidade Medica ID", "Descrição" }) {
            private static final long serialVersionUID = 1L;
        ...
        jBNovoRegistro.setText("Cadastrar nova Especialidade Médica");
    ...
    private void jTFPesquisaNomeFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_jTFPesquisaNomeFocusLost
        ...
        if ("".equals(verificar)) {
            ...
            jTable1.updateUI();
            int i = 0;
            while (i < listaEspecialidadesMedicas.size()) {
                DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
                modelo.addRow(new String[] { Integer.toString(listaEspecialidadesMedicas.get(i).getEmId()),
                    listaEspecialidadesMedicas.get(i).getDescricao() });
                i++;
            }
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Todas as Especialidades Médicas",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    private void jTFPesquisaNomeKeyReleased(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_jTFPesquisaNomeKeyReleased
        ...
        int i = 0;
        while (i < listaEspecialidadesMedicas.size()) {
            if (listaEspecialidadesMedicas.get(i).getDescricao().startsWith(jTFPesquisaNome.getText().toUpperCase())) {
                DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
                modelo.addRow(new String[] { Integer.toString(listaEspecialidadesMedicas.get(i).getEmId()),
                    listaEspecialidadesMedicas.get(i).getDescricao() });
            }
        ...
        if ("".equals(jTFPesquisaNome.getText())) {
            ...
            jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
                "Especialidade(s) Médica(s) encontrado(s) pela Pesquisa", javax.swing.border.TitledBorder.CENTER,
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jTable1MouseClicked
        ...
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas =
            new JIFCEspecialidadesMedicas("editar", especialidadeMedicaId);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicas.setVisible(true);
        int lDesk = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1.getWidth();
        ...
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameEspecialidadeMedicasVisualizar = null; // TODO add your handling
                                                                                            // code here:
