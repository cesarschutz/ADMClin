...
public class JIFCPacientes extends javax.swing.JInternalFrame {
	...
	public void iniciarClasse() {
		...
		if ("editar".equals(novoOuEditar)) {
			...
			while (cont < JIFCPacientesVisualizar.listaPacientes.size()) {
				...
				int codObjetos = JIFCPacientesVisualizar.listaPacientes.get(
						cont).getHandle_paciente();

				if (handle_paciente == codObjetos) {
					jTFNome.setText(JIFCPacientesVisualizar.listaPacientes.get(
							cont).getNome());
					...
					if (!"   .   .   -  "
							.equals(JIFCPacientesVisualizar.listaPacientes.get(
									cont).getCpf()))
						jTFCpf.setText(JIFCPacientesVisualizar.listaPacientes
								.get(cont).getCpf());
					...
					if (!"   ".equals(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getPeso()))
						jTFPeso.setText(JIFCPacientesVisualizar.listaPacientes
								.get(cont).getPeso());
					if (!"   ".equals(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getAltura()))
						jTFAltura
								.setText(JIFCPacientesVisualizar.listaPacientes
										.get(cont).getAltura());
					if (!"(  )     -    "
							.equals(JIFCPacientesVisualizar.listaPacientes.get(
									cont).getTelefone()))
					...
					if (!"(  )     -    "
						...
						jTFCelular
								.setText(JIFCPacientesVisualizar.listaPacientes
										.get(cont).getCelular());
					jTFEndereco.setText(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getEndereco());
					jTFBairro.setText(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getBairro());
					if (!"  .   -   "
							.equals(JIFCPacientesVisualizar.listaPacientes.get(
									cont).getCep()))
						jTFCep.setText(JIFCPacientesVisualizar.listaPacientes
								.get(cont).getCep());
					jTFCidade.setText(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getCidade());
					if (!"          "
							.equals(JIFCPacientesVisualizar.listaPacientes.get(
									cont).getRg()))
						jTFRg.setText(JIFCPacientesVisualizar.listaPacientes
								.get(cont).getRg());
					jTFProfissao.setText(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getProfissao());
					jTFEmail.setText(JIFCPacientesVisualizar.listaPacientes
							.get(cont).getEmail());
					jTFResponsavel
							.setText(JIFCPacientesVisualizar.listaPacientes
									.get(cont).getResponsavel());
					if (!"   .   .   -  "
							.equals(JIFCPacientesVisualizar.listaPacientes.get(
									cont).getCpfResponsavel()))
						jTFCpfResponsavel
								.setText(JIFCPacientesVisualizar.listaPacientes
										.get(cont).getCpfResponsavel());
					jTAObs.setText(JIFCPacientesVisualizar.listaPacientes.get(
							cont).getObs());
					if (!"(  )     -    "
							.equals(JIFCPacientesVisualizar.listaPacientes.get(
									cont).getTelefone_responsavel()))
						jTFTelefoneResponsavel
								.setText(JIFCPacientesVisualizar.listaPacientes
										.get(cont).getTelefone_responsavel());
					if (!"".equals(JIFCPacientesVisualizar.listaPacientes.get(
							cont).getSexo())) {
						if (JIFCPacientesVisualizar.listaPacientes.get(cont)
								.getSexo().equals("M")) {
							jCBSexo.setSelectedIndex(1);
						} else if (JIFCPacientesVisualizar.listaPacientes
								.get(cont).getSexo().equals("F")) {
					...
					if (!"".equals(JIFCPacientesVisualizar.listaPacientes.get(
							cont).getCor()))
						jCBCor.setSelectedItem(JIFCPacientesVisualizar.listaPacientes
								.get(cont).getCor());
					if (!"".equals(JIFCPacientesVisualizar.listaPacientes.get(
							cont).getEstadoCivil()))
						jCBEstadoCivil
								.setSelectedItem(JIFCPacientesVisualizar.listaPacientes
										.get(cont).getEstadoCivil());
					if (!"".equals(JIFCPacientesVisualizar.listaPacientes.get(
							cont).getUf()))
						jCBUf.setSelectedItem(JIFCPacientesVisualizar.listaPacientes
								.get(cont).getUf());
		...
		if ("novo".equals(novoOuEditar)) {
			jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(
					null, "Cadastro de novo Paciente",
					javax.swing.border.TitledBorder.CENTER,
					javax.swing.border.TitledBorder.DEFAULT_POSITION));
	...
	/**
	 * Volta a janela ao seu estado inicial, dexando inativo os jTextField por
	 * exemplo. Atualiza a tabela de acordo com os objetos.
	 */
	public void botaoCancelar() {
		...
		janelaPrincipal.jDesktopPane1
				.add(janelaPrincipal.internalFramePacienteVisualizar);
		...
		int lIFrame = janelaPrincipal.internalFramePacienteVisualizar
				.getWidth();
		int aIFrame = janelaPrincipal.internalFramePacienteVisualizar
				.getHeight();

		janelaPrincipal.internalFramePacienteVisualizar.setLocation(lDesk / 2
	...
	public boolean verificarSeNomeENascimentoFOramPreenchidosCorretamente() {
		...
		if (!"  /  /    ".equals(jTFNascimento.getText())) {
			NascimentoOK = MetodosUteis.verificarSeDataDeNascimentoEValida(
					jTFNascimento, jTFMensagemParaUsuario);
		}

		boolean nomeResponsavelOk = true;
		if (!"".equals(jTFResponsavel.getText()))
			nomeResponsavelOk = MetodosUteis.veriricarSeNomeDePessaoEhValido(
					jTFNome, jTFMensagemParaUsuario);

		boolean emailOk = true;
		if (!"".equals(jTFEmail.getText()))
			emailOk = MetodosUteis.verificarSeEmailEValido(jTFEmail,
					jTFMensagemParaUsuario);

		boolean nomeok = MetodosUteis.veriricarSeNomeDePessaoEhValido(jTFNome,
				jTFMensagemParaUsuario);
	...
	public void botaoSalvarRegistro() {
		...
		if (verificarSeNomeENascimentoFOramPreenchidosCorretamente()) {
			...
			pacienteModel.setEstadoCivil((String) jCBEstadoCivil
					.getSelectedItem());
			pacienteModel.setObs(jTAObs.getText());
			pacienteModel.setTelefone_responsavel(jTFTelefoneResponsavel
					.getText());
	...
	public void botaoApagarRegistro() {
		int resposta = JOptionPane.showConfirmDialog(null,
				"Deseja realmente deletar esse Paciente?", "ATENÇÃO", 0);
	...
	private void initComponents() {
		...
		jTFNascimento = new JFormattedTextField(
		...
		jTFCelular = new JFormattedTextField(
				MetodosUteis.mascaraParaJFormattedTextField("(##) ####-####"));
		jTFEndereco = new javax.swing.JTextField(
				new DocumentoSemAspasEPorcento(80), null, 0);
		...
		jTFCpfResponsavel = new JFormattedTextField(
				MetodosUteis.mascaraParaJFormattedTextField("###.###.###-##"));
		jLabel6 = new javax.swing.JLabel();
		jTFResponsavel = new javax.swing.JTextField(new DocumentoSomenteLetras(
				64), null, 0);
		...
		jTFTelefoneResponsavel = new JFormattedTextField(
				MetodosUteis.mascaraParaJFormattedTextField("(##) ####-####"));
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"Dados do Paciente", javax.swing.border.TitledBorder.CENTER,
				javax.swing.border.TitledBorder.DEFAULT_POSITION));
		...
		jCBEstadoCivil.setModel(new javax.swing.DefaultComboBoxModel(
		...
		jBAtualizarRegistro.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/br/bcn/admclin/imagens/atualizar.png"))); // NOI18N
		...
		jBApagarRegistro.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/br/bcn/admclin/imagens/deletar.png"))); // NOI18N
		...
		jBSalvarRegistro.setIcon(new javax.swing.ImageIcon(getClass()
				.getResource("/br/bcn/admclin/imagens/salvar.png"))); // NOI18N
		...
		layout.setHorizontalGroup(layout
				...
				.addComponent(jTFMensagemParaUsuario,
						javax.swing.GroupLayout.DEFAULT_SIZE, 664,
						Short.MAX_VALUE)
				.addGroup(
		...
		java.awt.Dimension screenSize = java.awt.Toolkit.getDefaultToolkit()
				.getScreenSize();
		setBounds((screenSize.width - 680) / 2, (screenSize.height - 583) / 2,
				680, 583);
	...
	private void jBAtualizarRegistroActionPerformed(
			java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jBAtualizarRegistroActionPerformed
	...
	private void jTFNascimentoFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_jTFNascimentoFocusLost
		...
		try {
			...
			String idade = MetodosUteis.calculaIdade(dataNascimentoString,
					"dd/MM/yyyy");
