...
public class JIFCConvenios extends javax.swing.JInternalFrame {
    ...
    public JIFCConvenios(String novoOuEditar, int handle_convenio) {
        ...
        if ("novo".equals(novoOuEditar)) {
            ...
            jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastrar novo Convênio",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        }
        if ("editar".equals(novoOuEditar)) {
            jBSalvar.setVisible(false);
            this.handle_convenio = handle_convenio;
            jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editar Convênio",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
            preencherConvenio();
        }
    }
//
    ...
    public void preencherConvenio() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                jTFPorcentConvenio.setText(colocarZeroNasPorcentagens(resultSet.getString("porcentconvenio")));

                jTFPorcentPaciente.setText(colocarZeroNasPorcentagens(resultSet.getString("porcentpaciente")));

                jTFRedutor.setText(colocarZeroNasPorcentagens(resultSet.getString("redutor")));
    ...
    /**
     * Metodo que coloca os "0" nos valores de procentagem que nao tiverem 0 na frente
     * 
     * @param verificar
    ...
    public void botaoSalvarEAtualizar() {
        if (verificarSeTudoFoiPreenchido()) {
            ...
            if (CONVENIO.conseguiuConsulta) {
                if (existe) {
                    JOptionPane.showMessageDialog(null, "Nome de Convênio já existe", "ATENÇÃO",
                    ...
                    try {
                        convenioMODEL.setUf(String.valueOf(jCBUf.getSelectedItem()));
                    } catch (Exception e) {
                    }
    ...
    private void initComponents() {
        ...
        jTFPorcentConvenio = new JFormattedTextField(MetodosUteis.mascaraParaJFormattedTextField("###.##"));
        jTFRedutor = new JFormattedTextField(MetodosUteis.mascaraParaJFormattedTextField("###.##"));
        jLabel19 = new javax.swing.JLabel();
        jTFPorcentPaciente = new JFormattedTextField(MetodosUteis.mascaraParaJFormattedTextField("###.##"));
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "AHAAAAM",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
        ...
        jCBUf.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AC", "AL", "AP", "AM", "BA", "CE", "DF",
            "ES", "GO", "MA", "MT", "MS", "MG", "PA", "PB", "PR", "PE", "PI", "RJ", "RN", "RS", "RO", "RR", "SC", "SP",
            "SE", "TO" }));
                                ...
                                jPanel1Layout
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            ...
                                            .addComponent(jTFTelefone, javax.swing.GroupLayout.PREFERRED_SIZE, 186,
                                        ...
                                        jPanel1Layout
                                            ...
                                            .addGroup(
                                                jPanel1Layout.createSequentialGroup().addComponent(jLabel9)
                                                    .addGap(0, 0, Short.MAX_VALUE)).addComponent(jTFContato)))
                            .addGroup(
                                jPanel1Layout
                                    .createSequentialGroup()
                                    .addComponent(jTFEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 354,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jCBVerificacao_matricula, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE))
                            .addGroup(
                                jPanel1Layout
                                    .createSequentialGroup()
                                                        ...
                                                        jPanel1Layout
                                                            ...
                                                            .addGroup(
                                                                jPanel1Layout
                                                                    .createParallelGroup(
                                                                        javax.swing.GroupLayout.Alignment.TRAILING,
                                                                        false)
                                                                    .addComponent(jTFPorcentConvenio,
                                                            ...
                                                            .addGroup(
                                                                jPanel1Layout
                                                                    ...
                                                                    .addComponent(jTFPorcentPaciente,
                                                ...
                                                jPanel1Layout
                                                    ...
                                                    .addGroup(
                                                        ...
                                                        jPanel1Layout
                                                            ...
                                                            .addPreferredGap(
                                                                javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                            .addComponent(jCBArquivoTextoFatura,
                        ...
                        jPanel1Layout
                            ...
                            .addGroup(
                                jPanel1Layout
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jTFContato, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addGroup(
                        jPanel1Layout
                            ...
                            .addComponent(jTFEmail, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jCBVerificacao_matricula, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGap(18, 18, 18)
                    .addGroup(
                        jPanel1Layout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel13)
                            .addComponent(jCBArquivoTextoFatura, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(
                        jPanel1Layout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel14)
                            .addComponent(jCBGrupo, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(
                        jPanel1Layout
                            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jBFilme, javax.swing.GroupLayout.PREFERRED_SIZE, 43,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(
                                jPanel1Layout
                                    .createSequentialGroup()
                                    ...
                                    .addGroup(
                                        jPanel1Layout
                                            .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jTFRedutor, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGroup(
                                                jPanel1Layout
                            ...
                            .addComponent(jLabel17)
                            .addComponent(jLabel19)
                            .addComponent(jBCh, javax.swing.GroupLayout.PREFERRED_SIZE, 43,
    ...
    private void jTFNomeFocusLost(java.awt.event.FocusEvent evt) {// GEN-FIRST:event_jTFNomeFocusLost
        ...
        if ("novo".equals(novoOuEditar) && nomePreenchido && handle_convenio == 0) {
            ...
            if (CONVENIO.conseguiuConsulta) {
                if (existe) {
                    JOptionPane.showMessageDialog(null, "Convênio já existe.", "ATENÇÃO",
                        javax.swing.JOptionPane.INFORMATION_MESSAGE);
                    ...
                    if (!cadastro) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(null,
                                "Erro ao verificar handle_convenio. Procure o Administrador", "ATENÇÃO",
                                javax.swing.JOptionPane.INFORMATION_MESSAGE);
                        }
                    }
                }
