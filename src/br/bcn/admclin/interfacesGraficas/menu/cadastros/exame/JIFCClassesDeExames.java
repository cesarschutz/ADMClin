...
public class JIFCClassesDeExames extends javax.swing.JInternalFrame {
    ...
    public void iniciarClasse() {
        ...
        if ("novo".equals(novoOuEditar)) {
            ...
            jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de nova Classe de Exame",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        } else {
            jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Editar Classe de Exame",
                javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
            ...
            while (cont < JIFCClassesDeExamesVisualizar.listaClassesDeExames.size()) {
                ...
                if (classeDeExameId == codObjetos) {
                    ...
                    jCBModalidade.setSelectedIndex(JIFCClassesDeExamesVisualizar.listaClassesDeExames.get(cont)
                        .getModIdx());
                }
                cont++;
            }
    ...
    public void botaoCancelar() {
        this.dispose();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExames = null;

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExamesVisualizar = new JIFCClassesDeExamesVisualizar();
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.jDesktopPane1
            .add(br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExamesVisualizar);
        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExamesVisualizar.setVisible(true);
        ...
        int lIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExamesVisualizar.getWidth();
        int aIFrame = br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExamesVisualizar.getHeight();

        br.bcn.admclin.interfacesGraficas.janelaPrincipal.janelaPrincipal.internalFrameClasseDeExamesVisualizar.setLocation(lDesk / 2 - lIFrame / 2,
            aDesk / 2 - aIFrame / 2);
    }
    ...
    public void botaoSalvarRegistro() {
        ...
        boolean modalidadePrenchida =
            MetodosUteis.VerificarSeComboBoxFoiSelecionado(jCBModalidade, jTFMensagemParaUsuario);
        ...
        if (descricaoPreenchida && modalidadePrenchida) {
            ...
            if (TB_CLASSESDEEXAMES.conseguiuConsulta) {
                if (existe) {
                    JOptionPane.showMessageDialog(null, "Classe de Exame já existe", "ATENÇÃO",
    ...
    public void botaoApagarRegistro() {
        int resposta =
            JOptionPane.showConfirmDialog(null, "Deseja realmente deletar essa Classe De Exame?", "ATENÇÃO", 0);
            ...
            if (TB_CLASSESDEEXAMES.conseguiuConsulta) {
                if (utilizada) {
                    JOptionPane.showMessageDialog(null,
                        "Esta Classe de Exame  não pode ser deletada pois está sendo utilizada por algum Exame",
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados da Classe de Exame",
            javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));
                ...
                jPanel3Layout
                    ...
                    .addGroup(
                        jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jLabel6).addComponent(jCBModalidade, 0, 429, Short.MAX_VALUE))
                    .addContainerGap()));
