 ...
 * papel 800
 */
package br.bcn.admclin.impressoes.modelo1.boletoDeRetirada;
...
public class ImprimirBoletoDeRetiradaModelo1 {
    ...
    public boolean salvarEIMprimirBoletoDeRetirada() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                "Não foi possível Criar Etiqueta. Procure o Administrador." + " 000001", "ERRO",
            ...
            JOptionPane.showMessageDialog(null,
                "Não foi possível Abrir Etiqueta. Procure o Administrador." + " 000001", "ERRO",
                javax.swing.JOptionPane.ERROR_MESSAGE);
        } finally {
    ...
    private void criarFichaPdf() throws DocumentException, FileNotFoundException {
        ...
        PdfWriter.getInstance(document, new FileOutputStream("C:\\ADMClin\\boletosDeRetirada\\boletoDeRetirada"
            + handle_at + ".pdf"));
        document.open();
