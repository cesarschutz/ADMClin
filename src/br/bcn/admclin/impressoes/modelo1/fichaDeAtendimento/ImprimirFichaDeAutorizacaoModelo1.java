 ...
 */
package br.bcn.admclin.impressoes.modelo1.fichaDeAtendimento;
 ...
 * @author BCN
 */
public class ImprimirFichaDeAutorizacaoModelo1 {
    ...
    public ImprimirFichaDeAutorizacaoModelo1(int handle_at) {
    ...
    public boolean salvarEImprimirFicha(){
        ...
        try {
           ...
           conseguiuAbrirAFicha = true;
            ...
            JOptionPane.showMessageDialog(null, "Não foi possível Criar Ficha de Atendimento. Procure o Administrador." + " 000001","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (DocumentException e) {
            JOptionPane.showMessageDialog(null, "Não foi possível Criar Ficha de Atendimento. Procure o Administrador." + " 000002","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (FileNotFoundException e) {
            //esse erro pode ocorrer caso o arquivo esteja aberto
            JOptionPane.showMessageDialog(null, "Não foi possível Criar Ficha de Atendimento. Procure o Administrador." + " 000003","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Não foi possível Abrir Ficha de Atendimento. Procure o Administrador." + " 000001","ERRO",javax.swing.JOptionPane.ERROR_MESSAGE);
        }finally{
    ...
    private String handle_paciente, nome_paciente, nascimento_paciente, sexo_paciente, telefone_paciente, peso_paciente, altura_paciente;
    private String nome_convenio, matricula_convenio, complemento, nome_medico_sol, crm_medico_sol, data_entrega_exame;
    ...
    private void buscarInformaçõesDoAtendimento() throws SQLException{
        ...
        while(resultSet.next()){
            handle_paciente = resultSet.getString("handle_paciente");
    ...
    private void criarFichaPdf() throws DocumentException, FileNotFoundException{
        ...
        PdfWriter.getInstance(document, new FileOutputStream("C:\\ADMClin\\fichaDeAtendimento\\ficha"+handle_at+".pdf"));
        document.open();
        ...
        //preenchendo os exames na tabela de exames depois vamos colocar essa tabela como linha da outra para ficar centralizada
        ...
        cell = new PdfPCell(new Phrase("Autorização para que o médico solicitante tenha acesso aos laudos\n"
